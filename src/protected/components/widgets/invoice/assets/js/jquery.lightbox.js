...
(function ($) {
  $.fn.lightbox = function (options) {
    ...
    function initialize() {
      ...
      var outerImage =
        '<div id="outerImageContainer"><div id="imageContainer"><iframe id="lightboxIframe"></iframe><img id="lightboxImage" /><div id="hoverNav"><a href="javascript://" title="' +
        opts.strings.prevLinkTitle +
        '" id="prevLink"></a><a href="javascript://" id="nextLink" title="' +
        opts.strings.nextLinkTitle +
        '"></a></div><div id="loading"><a href="javascript://" id="loadingLink"><img src="' +
        opts.fileLoadingImage +
        '"></a></div></div></div>';
      var imageData =
        '<div id="imageDataContainer" class="clearfix"><div id="imageData"><div id="imageDetails"><span id="caption"></span><span id="numberDisplay"></span></div><div id="bottomNav">';
      ...
      if (opts.navbarOnTop) {
        string =
          '<div id="overlay"></div><div id="lightbox">' +
          imageData +
          outerImage +
          "</div>";
        $("body").append(string);
    ...
    function showLightbox(imageObject) {
      ...
      if (!opts.jsonData) {
        ...
        if ((!imageObject.rel || imageObject.rel == "") && !opts.allSet) {
          ...
          opts.imageArray.push(
            new Array(
              imageObject.href,
              opts.displayTitle ? imageObject.title : ""
            )
          );
        } else {
          ...
          $("a").each(function () {
            if (this.href && this.rel == imageObject.rel) {
              opts.imageArray.push(
                new Array(this.href, opts.displayTitle ? this.title : "")
              );
            }
          });
        }
      ...
      $("#lightbox")
        .css({ top: lightboxTop + "px", left: lightboxLeft + "px" })
        .show();
      ...
      imgPreloader.onload = function () {
        ...
        if (opts.fitToScreen) {
          ...
          if (
            ...
            if (dI > dP) {
              newWidth = parseInt(
                (initialPageHeight / imgPreloader.height) * imgPreloader.width
              );
              newHeight = initialPageHeight;
            } else {
              newHeight = parseInt(
                (initialPageWidth / imgPreloader.width) * imgPreloader.height
              );
        ...
        if (!opts.disableNavbarLinks) {
          ...
          if (opts.activeImage > 0 || opts.loopImages) {
            nav_html =
              ...
              opts.strings.prevLinkText +
              "</a>" +
              nav_html;
          }

          if (
            opts.activeImage + 1 < opts.imageArray.length ||
            opts.loopImages
          ) {
            nav_html +=
              '<a title="' +
              opts.strings.nextLinkTitle +
              '" href="#" id="nextLinkText">' +
              opts.strings.nextLinkText +
              "</a>";
          }
        }
    ...
    function keyboardAction(e) {
      ...
      if (key == "x" || key == "o" || key == "c" || keycode == escapeKey) {
        ...
        if (o.loopImages) {
          disableKeyboardNav();
          changeImage(
            o.activeImage == 0 ? o.imageArray.length - 1 : o.activeImage - 1
          );
        ...
        if (opts.loopImages) {
          disableKeyboardNav();
          changeImage(
            o.activeImage == o.imageArray.length - 1 ? 0 : o.activeImage + 1
          );
