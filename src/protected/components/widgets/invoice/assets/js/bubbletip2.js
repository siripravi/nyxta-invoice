      ...
      var buildaToolTip1 = function () {
          $("body").append(
            "<div id='" +
              ...
              "'><p class='aToolTip1Content'>" +
              tipContent +
              "</p><em></em></div>"
          );

          if (tipContent && settings.clickIt) {
            $("#" + settings.toolTipId + " p.aToolTip1Content").append(
              "<a id='" +
                settings.closeTipBtn +
                "' href='#' alt='close'>close</a>"
            );
          }
        },
        /**
