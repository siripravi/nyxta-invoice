...
(function () {
        ...
        compile: function (tElement, tAttrs) {
          ...
          return function link(scope, element, attrs, $select, transcludeFn) {
            ...
            choices
              .attr(
                "ng-repeat",
                RepeatParser.getNgRepeatExpression(
              ...
              .attr(
                "ng-mouseenter",
                "$select.setActiveItem(" + $select.parserResult.itemName + ")"
              )
              .attr(
                "ng-click",
                "$select.select(" +
            ...
            var rowsInner = element.querySelectorAll(
    ...
    function (
      ...
      function _resetSearchInput() {
        if (
          ...
          (ctrl.resetSearchInput === undefined &&
            uiSelectConfig.resetSearchInput)
        ) {
          ctrl.search = EMPTY_SEARCH;
          //reset activeIndex
      ...
      ctrl.activate = function (initSearchValue, avoidReset) {
        if (!ctrl.disabled && !ctrl.open) {
          ...
          ctrl.activeIndex =
            ctrl.activeIndex >= ctrl.items.length ? 0 : ctrl.activeIndex;
      ...
      ctrl.isDisabled = function (itemScope) {
        ...
        if (
          itemIndex >= 0 &&
          !angular.isUndefined(ctrl.disableChoiceExpression)
        ) {
      ...
      ctrl.searchInput.on("paste", function (e) {
        ...
        if (
          data &&
          data.length > 0 &&
          ctrl.taggingTokens.isActivated &&
          ctrl.tagging.fct
        ) {
        ...
        compile: function (tElement, tAttrs) {
          ...
          return function (scope, element, attrs, ctrls, transcludeFn) {
            ...
            scope.$watch("sortable", function () {
              ...
              $select.sortable =
                sortable !== undefined ? sortable : uiSelectConfig.sortable;
            });
            ...
            attrs.$observe("resetSearchInput", function () {
              ...
              $select.resetSearchInput =
                resetSearchInput !== undefined ? resetSearchInput : true;
            });
            ...
            function onDocumentClick(e) {
              ...
              if (!contains && !$select.clickTriggeredSelect) {
                ...
                var skipFocusser =
                  targetScope &&
                  targetScope.$select &&
                  targetScope.$select !== $select; //To check if target is other ui-select
                if (!skipFocusser)
            ...
            transcludeFn(scope, function (clone) {
              ...
              var transcludedMatch =
                transcluded.querySelectorAll(".ui-select-match");
              ...
              var transcludedChoices =
                transcluded.querySelectorAll(".ui-select-choices");
    ...
    function (uiSelectConfig) {
      return {
        ...
        templateUrl: function (tElement) {
          ...
          return (
            theme + (multi ? "/match-multiple.tpl.html" : "/match.tpl.html")
          );
        },
            ...
            var checkFnMultiple = function (list, value) {
              ...
              for (var p = list.length - 1; p >= 0; p--) {
                ...
                if ($select.parserResult.trackByExp) {
                  ...
                  if (
                    matches.length > 0 &&
                    result[matches[1]] == value[matches[1]]
                  ) {
          ...
          $select.searchInput.on("keyup", function (e) {
            ...
            if ($select.tagging.isActivated && $select.search.length > 0) {
              ...
              if ($select.tagging.fct !== undefined) {
                ...
                if (
                  stashArr.filter(function (origItem) {
                    return angular.equals(
                      origItem,
                      $select.tagging.fct($select.search)
                    );
                  }).length > 0
                ) {
                  return;
                ...
                if (
                  _findCaseInsensitiveDupe(stashArr.concat($select.selected))
                ) {
          ...
          function _findCaseInsensitiveDupe(arr) {
            ...
            var hasDupe =
              arr.filter(function (origItem) {
                if (
                  $select.search.toUpperCase() === undefined ||
                  origItem === undefined
                ) {
                  return false;
                }
      ...
      return {
        ...
        link: function (scope, element, attrs, $select) {
          ...
          element.on("dragstart", function (e) {
            ...
            (e.dataTransfer || e.originalEvent.dataTransfer).setData(
              "text/plain",
              scope.$index
            );
          });
          ...
          var dragOverHandler = function (e) {
            ...
            var offset =
              axis === "vertical"
                ? e.offsetY ||
                  e.layerY ||
                  (e.originalEvent ? e.originalEvent.offsetY : 0)
                : e.offsetX ||
                  e.layerX ||
            ...
            if (
              offset <
              this[axis === "vertical" ? "offsetHeight" : "offsetWidth"] / 2
            ) {
          ...
          var dropHandler = function (e) {
            ...
            var droppedItemIndex = parseInt(
              (e.dataTransfer || e.originalEvent.dataTransfer).getData(
                "text/plain"
              ),
              10
            );
  ...
  uis.service("uisRepeatParser", [
    ...
    function (uiSelectMinErr, $parse) {
      ...
      self.getNgRepeatExpression = function (
        itemName,
        source,
        trackByExp,
        grouped
        ...
        var expression =
          itemName + " in " + (grouped ? "$group.items" : source);
        if (trackByExp) {
...
angular.module("ui.select").run([
  ...
  function ($templateCache) {
    ...
    $templateCache.put(
      ...
      '<div class="ui-select-container ui-select-bootstrap dropdown" ng-class="{open: $select.open}"><div class="ui-select-match"></div><input type="text" autocomplete="off" tabindex="-1" aria-expanded="true" aria-label="{{ $select.baseTitle }}" aria-owns="ui-select-choices-{{ $select.generatedId }}" aria-activedescendant="ui-select-choices-row-{{ $select.generatedId }}-{{ $select.activeIndex }}" class="form-control ui-select-search" placeholder="{{$select.placeholder}}" ng-model="$select.search" ng-show="$select.searchEnabled && $select.open"><div class="ui-select-choices"></div></div>'
    );
    $templateCache.put(
    ...
    $templateCache.put(
      ...
      '<div class="ui-select-container selectize-control single" ng-class="{\'open\': $select.open}"><div class="selectize-input" ng-class="{\'focus\': $select.open, \'disabled\': $select.disabled, \'selectize-focus\' : $select.focus}" ng-click="$select.activate()"><div class="ui-select-match"></div><input type="text" autocomplete="off" tabindex="-1" class="ui-select-search ui-select-toggle" ng-click="$select.toggle($event)" placeholder="{{$select.placeholder}}" ng-model="$select.search" ng-hide="!$select.searchEnabled || ($select.selected && !$select.open)" ng-disabled="$select.disabled" aria-label="{{ $select.baseTitle }}"></div><div class="ui-select-choices"></div></div>'
    );
  },
]);
