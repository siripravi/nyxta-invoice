...
$this->addForeignKey('fk_customer_cards_customer_customer_no', 'customer_cards', 'customer_no', 'customer',
'customer_no', 'NO ACTION', 'NO ACTION');

$this->addForeignKey('fk_employee_designation_emp_type_id', 'employee', 'emp_type_id', 'designation', 'emp_type_id', 'NO
ACTION', 'NO ACTION');

$this->addForeignKey('fk_mov_employee_employee_emp_id', 'mov_employee', 'emp_id', 'employee', 'id', 'NO ACTION', 'NO
ACTION');

$this->addForeignKey('fk_mov_employee_movement_mov_id', 'mov_employee', 'mov_id', 'movement', 'id', 'NO ACTION', 'NO
ACTION');
