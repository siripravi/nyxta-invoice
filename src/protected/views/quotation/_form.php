...
<div id="inv-err-div" style="display:none">
    <div class="box box-warning alert alert-warning">
        <div class="box-header">
            <h4><span><i class="fa fa-warning"></i></span>
                <span>Please correct these errors and resubmit the form!</span>
            </h4>
        </div>
...
<div class="row">
    <div class="col-md-6" style="">
        <div class="form-group" style="position: static;">
            <?php echo $form->labelEx($quotation, 'quotation_id', array('class' => 'control-label')); ?>
            <?php echo $form->textField($quotation, 'quotation_id', array('class' => 'form-control')); ?>
            <p class="help-block">Example block-level help text here.</p>
        </div>
        <div class="form-group" style="position: static;">
            <?php echo $form->labelEx($statement, 'ship_date', array('class' => 'control-label')); ?>
            <div class="input-group">
                <?php echo $form->dateField($statement, 'ship_date'); ?>
                <p class="help-block">Example block-level help text here.</p>
            </div>
        </div>
    </div>
...
<div class="row text-center">
    <?php
    $qurl = !empty($quotation->st_id) ?
        '/quotation/create?id=' . $quotation->st_id :
        '/quotation/create';

    echo CHtml::ajaxSubmitButton('Submit', $qurl, array(
        'beforeSend' => 'function(){
                                    // js:alert("sending.."); 
                                    $("#inv-err-div").hide();
                            }',
        ...
        'success' => 'function(data){	  //   js:alert(data);   	  
                                         ...
                                         if(obj.posted == "success") 
                                                          window.location.href = "/quotation/update/id/"+ obj.id;
                                                     else{
                                                     var str = "";
