      ...
      function (W, H) {
        ...
        W.decorator("$animate", [
          ...
          function (x, G, aa, L, F, I, Q) {
            ...
            function s(a, b, c, d, f, e, q) {
              ...
              if (p) {
                ...
                var u = l.totalActive || 0,
                  C = l.last;
                if (
                  (p.isClassBased && (l.disabled || (C && !C.isClassBased))) ||
                  O(c, d)
                )
                  v(), n(), A(), z();
                else {
                  ...
                  if (d) n(), A(), y();
                    ...
                    p.before(function (d) {
                      ...
                      d =
                        ...
                        !e ||
                        !e.active[b] ||
                        (p.isClassBased && e.active[b].event != a);
                      v();
                      !0 === d ? z() : (A(), p.after(z));
                    });
                  }
            ...
            function U(a) {
              if ((a = e(a)))
                (a = g.isFunction(a.getElementsByClassName)
                  ? a.getElementsByClassName(K)
                  : a.querySelectorAll("." + K)),
                  m(a, function (a) {
                    a = g.element(a);
                    (a = a.data(h)) &&
                      a.active &&
                      m(a.active, function (a) {
                        a.cancel();
                      });
                  });
            }
            function E(a, b) {
              if (e(a) == e(L))
                q.disabled || ((q.running = !1), (q.structural = !1));
              else if (b) {
                var c = a.data(h) || {},
                  d = !0 === b;
                !d &&
        ...
        H.register("", [
          ...
          function (h, q, B, L) {
            ...
            function V(a, b, c, f) {
              ...
              if (-1 != p.className.indexOf(c) && a) {
                ...
                if (0 < t.transitionDuration) {
                  ...
                  -1 == B.indexOf("all") &&
                    ((s += D + "transition-property: " + B + ";"),
                    (s +=
                      D +
                      "transition-duration: " +
                      t.transitionDurationStyle +
                      ";"),
                    u.push(D + "transition-property"),
                    u.push(D + "transition-duration"));
                }
                0 < r &&
                  (0 < n.transitionDelay &&
                    ...
                    ((s +=
                      D +
                      "transition-delay: " +
                      T(t.transitionDelayStyle, n.transitionDelay, r) +
                      "; "),
                    u.push(D + "transition-delay")),
                  0 < n.animationDelay &&
                    0 === n.animationDuration &&
                    ((s +=
                      D +
                      "animation-delay: " +
                      T(t.animationDelayStyle, n.animationDelay, r) +
                      "; "),
                    u.push(D + "animation-delay")));
                0 < u.length &&
                  ((t = p.getAttribute("style") || ""),
                  p.setAttribute("style", t + " " + s));
                b.on(y, h);
                b.addClass(q);
                ...
                p =
                  (r * (Math.max(n.animationDelay, n.transitionDelay) || 0) +
                    (w + v) * W) *
                  ca;
                a.running++;
                I(b, p);
            ...
            function d(a, b) {
              ...
              c &&
                (c.running && c.running--,
                (c.running && 0 !== c.running) || a.removeData(l));
            }
            function f(a, b) {
              var c = "";
            ...
            var D = "",
              ...
              n,
              A;
            G.ontransitionend === Q && G.onwebkittransitionend !== Q
              ? ((D = "-webkit-"),
                (J = "WebkitTransition"),
                (H = "webkitTransitionEnd transitionend"))
              : ((J = "transition"), (H = "transitionend"));
            G.onanimationend === Q && G.onwebkitanimationend !== Q
              ? ((D = "-webkit-"),
                (n = "WebkitAnimation"),
                (A = "webkitAnimationEnd animationend"))
              : ((n = "animation"), (A = "animationend"));
            var y = "Duration",
              v = "Property",
              z = "Delay",
              p = "IterationCount",
