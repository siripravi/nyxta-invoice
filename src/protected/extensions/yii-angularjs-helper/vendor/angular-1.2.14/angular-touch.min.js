            ...
            if (d && r) {
              ...
              (10 > l && 10 > n) ||
                (n > l
                  ...
                  : (a.preventDefault(), b.move && b.move(m, a)));
            }
          });
      ...
      return function (a, c, d) {
        ...
        c.on("touchend", function (a) {
          var h = Date.now() - t,
            ...
            e = g.clientX,
            g = g.clientY,
            p = Math.sqrt(Math.pow(e - w, 2) + Math.pow(g - x, 2));
          q &&
            750 > h &&
            12 > p &&
            (k ||
              (b[0].addEventListener("click", n, !0),
              b[0].addEventListener("touchstart", r, !0),
              (k = [])),
            (m = Date.now()),
            l(k, e, g),
            s && s.blur(),
            (v.isDefined(d.disabled) && !1 !== d.disabled) ||
              c.triggerHandler("click", [a]));
          f();
        });
