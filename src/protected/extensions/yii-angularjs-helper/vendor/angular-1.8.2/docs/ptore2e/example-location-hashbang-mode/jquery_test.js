describe("", function () {
  ...
  beforeEach(function () {
    ...
    browser.get(
      "build/docs/examples/example-location-hashbang-mode/index-jquery.html"
    );
  });
  ...
  it("should change $location accordingly", function () {
    ...
    expect(addressBar.getAttribute("value")).toBe(
      "http://www.example.com/base/index.html#!/first?a=b"
    );
    ...
    expect(addressBar.getAttribute("value")).toBe(
      "http://www.example.com/base/index.html#!/sec/ond?flag#hash"
    );
