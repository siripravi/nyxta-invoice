        ...
        function (d, F, G, N) {
          ...
          C.prototype = {
            setUrlParams: function (a, d, f) {
              ...
              r(g.urlParams, function (b, a) {
                ...
                D(s) && null !== s
                  ? ((h = b.isQueryParamValue ? y(s, !0) : S(s)),
                    (c = c.replace(
                      new RegExp(":" + a + "(\\W|$)", "g"),
                      function (b, a) {
                        return h + a;
              ...
              g.defaults.stripTrailingSlashes &&
                (c = c.replace(/\/+$/, "") || "/");
              c = c.replace(/\/\.(?=\w+($|\?))/, ".");
              a.url = n + c.replace(/\/(\\|%5C)\./, "/.");
              r(d, function (b, c) {
                g.urlParams[c] ||
                  ((a.params = a.params || {}), (a.params[c] = b));
              });
            },
          };
          return function (m, y, z, g) {
            ...
            r(z, function (b, a) {
              var f =
                  !0 === b.hasBody ||
                  (!1 !== b.hasBody && /^(POST|PUT|PATCH)$/i.test(b.method)),
                g = b.timeout,
              ...
              h[a] = function (e, k, J, y) {
                ...
                var E = this instanceof h,
                  ...
                  H =
                    (b.interceptor && b.interceptor.responseError) || G.reject,
                  I = t
                    ? function (a) {
