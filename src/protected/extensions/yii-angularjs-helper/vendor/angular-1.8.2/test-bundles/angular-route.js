          ...
          function (
            ...
            var contains =
              ...
              /** @this */ function (arg) {
                ...
                return (
                  this === arg || !!(this.compareDocumentPosition(arg) & 16)
                );
              };
            ...
            function areAnimationsAllowed(node, parentNode, event) {
              ...
              while (parentNode) {
                ...
                if (!parentAnimationDetected) {
                  var parentNodeDisabled =
                    disabledElementsLookup.get(parentNode);

                  if (
                    parentNodeDisabled === true &&
 ...
 */
  ...
  describe("ngView", function () {
    describe("basics", function () {
      ...
      beforeEach(
        module(function ($provide) {
          return function ($rootScope, $compile, $animate) {
            element = $compile(
              '<div><ng:view onload="load()"></ng:view></div>'
            )($rootScope);
          };
        })
      );
      ...
      it("should do nothing when no routes are defined", inject(function (
        $rootScope,
        $compile,
        $location
      ) {
      ...
      it("should be possible to nest ngView in ngInclude", function () {
        ...
        inject(function (
          ...
          $httpBackend
            .whenGET("includePartial.html")
            .respond("view: <ng:view></ng:view>");
      ...
      it(
        "should initialize view template after the view controller was initialized even when " +
      ...
      it(
        "should discard pending xhr callbacks if a new route is requested before the current " +
          "finished loading",
        function () {
      ...
      it("should destroy previous scope if multiple route changes occur before server responds", function () {
        var log = [];
        ...
        module(function ($routeProvider) {
          $routeProvider.when("/one", {
            ...
            controller: createCtrl("ctrl1"),
          });
          $routeProvider.when("/two", {
            templateUrl: "two.html",
            controller: createCtrl("ctrl2"),
          });
        });
      ...
      it("should $destroy scope after update and reload", function () {
        ...
        module(function ($routeProvider) {
          $routeProvider.when("/bar", {
            templateUrl: "tpl.html",
            controller: createController("bar"),
          });
          $routeProvider.when("/foo", {
            templateUrl: "tpl.html",
      ...
      it("should set $scope and $controllerController on the view elements (except for non-element nodes)", function () {
        ...
        inject(function ($templateCache, $location, $rootScope, $route) {
          ...
          expect(div.parent()[0].nodeName.toUpperCase()).toBeOneOf(
            "NG:VIEW",
            "VIEW"
          );
    ...
    describe("and transcludes", function () {
      ...
      beforeEach(
        module("ngRoute", function ($compileProvider) {
          element = null;
      ...
      it("should compile its content correctly (although we remove it later)", function () {
        ...
        inject(function ($compile, $rootScope, $location) {
          element = $compile(
            "<div><div ng-view><div test someAttr></div></div></div>"
          )($rootScope);
          $location.url("/view");
          $rootScope.$apply();
    ...
    describe("animations", function () {
      ...
      describe("hooks", function () {
        ...
        it("should fire off the enter animation", inject(function (
          $compile,
          $rootScope,
          $location,
          $timeout,
        ...
        it("should fire off the leave animation", inject(function (
          $compile,
          $rootScope,
          $location,
          $templateCache,
        ...
        it("should animate two separate ngView elements", inject(function (
          $compile,
          $rootScope,
          $templateCache,
          $location,
        ...
        it("should render ngClass on ngView", inject(function (
          $compile,
          $rootScope,
          $templateCache,
          $animate,
          ...
          element = $compile(
            html('<div><div ng-view ng-class="klass"></div></div>')
          )($rootScope);
          $rootScope.$digest();
        ...
        it("should not double compile when the route changes", function () {
          ...
          module(function ($routeProvider, $animateProvider, $provide) {
            $routeProvider.when("/foo", {
              template: '<div ng-repeat="i in [1,2]">{{i}}</div>',
            });
            $routeProvider.when("/bar", {
              template: '<div ng-repeat="i in [3,4]">{{i}}</div>',
            });
          ...
          inject(function (
            ...
            element = $compile(
              html(
                '<div><ng:view onload="load()" class="my-animation"></ng:view></div>'
              )
            )($rootScope);
        ...
        it("should destroy the previous leave animation if a new one takes place", inject(function (
          $compile,
          $rootScope,
          $animate,
          $location,
          ...
          element = $compile(html("<div>" + "<div ng-view></div>" + "</div>"))(
            $scope
          );
      ...
      describe("autoscroll", function () {
        ...
        it("should call $anchorScroll if autoscroll evaluates to true", inject(
          compileAndLink(
            '<div><ng:view src="tpl" autoscroll="value"></ng:view></div>'
          ),
          function ($rootScope, $animate, $timeout, $location) {
    ...
    describe("in async template", function () {
      beforeEach(module("ngRoute"));
      beforeEach(
        module(function ($compileProvider, $provide, $routeProvider) {
  ...
  describe("$routeProvider", function () {
    ...
    it("should support enabling/disabling automatic instantiation upon initial load", inject(function () {
      expect($routeProvider.eagerInstantiationEnabled(true)).toBe(
        $routeProvider
      );
      expect($routeProvider.eagerInstantiationEnabled()).toBe(true);

      expect($routeProvider.eagerInstantiationEnabled(false)).toBe(
        $routeProvider
      );
  ...
  describe("$route", function () {
    ...
    beforeEach(
      module(function () {
        return function (_$httpBackend_) {
          ...
          $httpBackend
            .when("GET", "http://example.com/trusted-template.html")
            .respond("cross domain trusted template");
    ...
    it("should route and fire change event when catch-all params are used", function () {
      ...
      inject(function ($route, $location, $rootScope) {
        ...
        log = "";
        $location
          .path("/Book1/Moby/Chapter/Intro/one/two/edit")
          .search("p=123");
        $rootScope.$digest();
        expect(log).toEqual("before();after();");
        expect($route.current.params).toEqual({
    ...
    describe("should match a route that contains special chars in the path", function () {
      ...
      it("matches the full path", inject(function (
        $route,
        $location,
        $rootScope
      ) {
      ...
      it("treats backslashes normally", inject(function (
        $route,
        $location,
        $rootScope
      ) {
      ...
      it("matches a URL with special chars", inject(function (
        $route,
        $location,
        $rootScope
      ) {
    ...
    describe("should match a route that contains optional params in the path", function () {
      beforeEach(
        module(function ($routeProvider) {
          $routeProvider.when("/test/:opt?/:baz/edit", {
            templateUrl: "test.html",
          });
        })
      );

      it("matches a URL with optional params", inject(function (
        $route,
        $location,
        $rootScope
      ) {
      ...
      it("matches a URL without optional param", inject(function (
        $route,
        $location,
        $rootScope
      ) {
      ...
      it("not match a URL with a required param", inject(function (
        $route,
        $location,
        $rootScope
      ) {
    ...
    describe("events", function () {
      ...
      it("should fetch templates", function () {
        ...
        inject(function ($route, $httpBackend, $location, $rootScope) {
          ...
          $httpBackend.flush();
          expect(log).toBe(
            "$before(r1.html);$before(r2.html);$after(r2.html);"
          );
      ...
      it("should NOT load cross domain templates by default", function () {
        module(function ($routeProvider) {
          $routeProvider.when("/foo", {
            templateUrl: "http://example.com/foo.html",
          });
        });
      ...
      it("should load cross domain templates that are trusted", function () {
        ...
        inject(function ($route, $location, $rootScope) {
          $httpBackend
            .whenGET("http://example.com/foo.html")
            .respond("FOO BODY");
          $location.path("/foo");
          $rootScope.$digest();
          $httpBackend.flush();
    ...
    it("should support custom `$sce` implementations", function () {
      ...
      inject(function ($location, $rootScope, $route, $sce) {
        $routeProvider.when("/foo", {
          templateUrl: $sce.trustAsResourceUrl("foo.html"),
        });
    ...
    describe("redirection", function () {
      describe("via `redirectTo`", function () {
        ...
        it("should interpolate route vars in the redirected path from original path", function () {
          module(function ($routeProvider) {
            $routeProvider.when("/foo/:id/foo/:subid/:extraId", {
              redirectTo: "/bar/:id/:subid/23",
            });
            $routeProvider.when("/bar/:id/:subid/:subsubid", {
              templateUrl: "bar.html",
            });
            $routeProvider.when("/baz/:id/:path*", {
              redirectTo: "/path/:path/:id",
            });
            $routeProvider.when("/path/:path*/:id", {
              templateUrl: "foo.html",
            });
          });
        ...
        it("should properly process route params which are both eager and optional", function () {
          module(function ($routeProvider) {
            $routeProvider.when("/foo/:param1*?/:param2", {
              templateUrl: "foo.html",
            });
          });
        ...
        it(
          "should properly interpolate optional and eager route vars " +
            "when redirecting from path with trailing slash",
          function () {
            module(function ($routeProvider) {
              $routeProvider.when("/foo/:id?/:subid?", {
                templateUrl: "foo.html",
              });
              $routeProvider.when("/bar/:id*/:subid", {
                templateUrl: "bar.html",
              });
            });
        ...
        it("should replace the url when redirecting", function () {
          ...
          inject(function ($browser, $route, $location, $rootScope) {
            var $browserUrl = spyOnlyCallsWithArgs(
              $browser,
              "url"
            ).and.callThrough();
        ...
        it("should not process route bits", function () {
          ...
          var firstTemplate = jasmine
            .createSpy("first template spy")
            .and.returnValue("redirected view");
          var firstResolve = jasmine.createSpy("first resolve spy");
          var secondController = jasmine.createSpy("second controller spy");
          var secondTemplate = jasmine
            .createSpy("second template spy")
            .and.returnValue("redirected view");
          ...
          inject(function ($route, $location, $rootScope, $compile) {
            var element = $compile("<div><ng-view></ng-view></div>")(
              $rootScope
            );
            $location.path("/redirect");
            $rootScope.$digest();
      ...
      describe("via `resolveRedirectTo`", function () {
        ...
        it("should be ignored if `redirectTo` is also present", function () {
          ...
          var resolveRedirectToSpy = jasmine
            .createSpy("resolveRedirectTo")
            .and.returnValue("/bar");
          var redirectToSpy = jasmine
            .createSpy("redirectTo")
            .and.callFake(getNewUrl);
    ...
    describe("reloadOnUrl", function () {
      ...
      describe("with `$route.reload()`", function () {
        ...
        it("should reload the current route even if `reloadOnUrl` is disabled", inject(function (
          $routeParams
        ) {
          $location.path("/path/foo");
          $rootScope.$digest();
    ...
    describe("reloadOnSearch", function () {
      ...
      it("should allow using a function as a templateUrl", function () {
        var customTemplateUrlWatcher = jasmine.createSpy(
          "customTemplateUrlWatcher"
        );
      ...
      describe("with `$route.reload()`", function () {
        ...
        it("should reload even if reloadOnSearch is false", inject(function (
          $routeParams
        ) {
          $location.path("/bar/123");
          $rootScope.$digest();
    ...
    describe("update", function () {
      ...
      it("should support total multi-parameter route updating", function () {
        ...
        module(function ($routeProvider) {
          $routeProvider.when("/bar/:barId/:fooId/:spamId/:eggId", {
            controller: angular.noop,
          });
        });
      ...
      it("should update query params when new properties are not in path", function () {
        ...
        module(function ($routeProvider) {
          $routeProvider.when("/bar/:barId/:fooId/:spamId/", {
            controller: angular.noop,
          });
        });
      ...
      it("should complain if called without an existing route", inject(function (
        $route
      ) {
        expect(function () {
          $route.updateParams();
