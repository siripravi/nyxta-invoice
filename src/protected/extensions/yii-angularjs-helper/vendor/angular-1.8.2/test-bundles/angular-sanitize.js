 ...
 */
  ...
  describe("ngBindHtml", function () {
    ...
    it("should reset html when value is null or undefined", inject(function (
      $compile,
      $rootScope
    ) {
      var element = $compile('<div ng-bind-html="html"></div>')($rootScope);
  ...
  describe("linky", function () {
    ...
    it("should do basic filter", function () {
      expect(
        linky(
          "http://ab/ (http://a/) <http://a/> http://1.2/v:~-123. c “http://example.com” ‘http://me.com’"
        )
      ).toEqual(
    ...
    it("should throw an error when used with a non-string value (other than `undefined`/`null`)", function () {
      expect(function () {
        linky(false);
      }).toThrowMinErr(
        "linky",
      ...
      expect(function () {
        ...
        "linky",
        "notstring",
        "Expected string but received: 42"
      );
      ...
      expect(function () {
        ...
        "linky",
        "notstring",
        "Expected string but received: function noop()"
      );
    });
    ...
    it("should be case-insensitive", function () {
      ...
      expect(linky("SFTP://www.example.com")).toEqual(
        '<a href="SFTP://www.example.com">SFTP://www.example.com</a>'
      );
      expect(linky("SFTP://example.com")).toEqual(
        '<a href="SFTP://example.com">SFTP://example.com</a>'
      );
    });
    ...
    it("should handle mailto:", function () {
      expect(linky("mailto:me@example.com")).toEqual(
        '<a href="mailto:me@example.com">me@example.com</a>'
      );
      expect(linky("me@example.com")).toEqual(
        '<a href="mailto:me@example.com">me@example.com</a>'
      );
      expect(linky("send email to me@example.com, but")).toEqual(
        'send email to <a href="mailto:me@example.com">me@example.com</a>, but'
      );
      expect(linky('my email is "me@example.com"')).toEqual(
        'my email is &#34;<a href="mailto:me@example.com">me@example.com</a>&#34;'
      );
    });
    ...
    it("should handle target:", function () {
      expect(linky("http://example.com", "_blank")).toBeOneOf(
        '<a target="_blank" href="http://example.com">http://example.com</a>',
        '<a href="http://example.com" target="_blank">http://example.com</a>'
      );
      expect(linky("http://example.com", "someNamedIFrame")).toBeOneOf(
        '<a target="someNamedIFrame" href="http://example.com">http://example.com</a>',
    ...
    describe("custom attributes", function () {
      it("should optionally add custom attributes", function () {
        expect(
          linky("http://example.com", "_self", { rel: "nofollow" })
        ).toBeOneOf(
          '<a rel="nofollow" target="_self" href="http://example.com">http://example.com</a>',
      ...
      it("should override target parameter with custom attributes", function () {
        expect(
          linky("http://example.com", "_self", { target: "_blank" })
        ).toBeOneOf(
          '<a target="_blank" href="http://example.com">http://example.com</a>',
          '<a href="http://example.com" target="_blank">http://example.com</a>'
        );
      ...
      it("should optionally add custom attributes from function", function () {
        expect(
          linky("http://example.com", "_self", function (url) {
            return { class: "blue" };
          })
        ).toBeOneOf(
          '<a class="blue" target="_self" href="http://example.com">http://example.com</a>',
      ...
      it("should pass url as parameter to custom attribute function", function () {
        var linkParameters = jasmine
          .createSpy("linkParameters")
          .and.returnValue({ class: "blue" });
  ...
  describe("HTML", function () {
    ...
    it("should echo html", function () {
      expectHTML('hello<b class="1\'23" align=\'""\'>world</b>.').toBeOneOf(
    ...
    it("should mangle improper html2", function () {
      ...
      expectHTML('< div rel="</div>" / >').toBe(
        "&lt; div rel=&#34;&#34; / &gt;"
      );
    });

    it("should ignore back slash as escape", function () {
      expectHTML('<img alt="xxx\\" title="><script>....">').toBeOneOf(
    ...
    it("should not allow JavaScript execution when creating inert document", inject(function (
      $sanitize
    ) {
    ...
    it("should not allow JavaScript hidden in badly formed HTML to get through sanitization (Firefox bug)", inject(function (
      $sanitize
    ) {
      var doc = $sanitize(
    ...
    describe("Custom white-list support", function () {
      ...
      beforeEach(
        module(function (_$sanitizeProvider_) {
      ...
      it("should allow custom white-listed element", function () {
        ...
        expectHTML("<foo-video></foo-video>").toEqual(
          "<foo-video></foo-video>"
        );
      });
      ...
      it("should not allow add custom element after service has been instantiated", inject(function (
        $sanitize
      ) {
    ...
    describe("SVG support", function () {
      beforeEach(
        module(function ($sanitizeProvider) {
      ...
      it("should not ignore white-listed svg camelCased attributes", function () {
        expectHTML('<svg preserveAspectRatio="true"></svg>').toBeOneOf(
      ...
      it("should not accept SVG `use` tags", function () {
        expectHTML('<svg><use xlink:href="test.svg#xss" /></svg>').toBeOneOf(
          "<svg></svg>",
    ...
    describe("uri checking", function () {
      ...
      it("should use $$sanitizeUri for a[href] links", function () {
        ...
        inject(function () {
          ...
          expectHTML('<a href="someUri"></a>').toEqual(
            '<a href="someUri"></a>'
          );
