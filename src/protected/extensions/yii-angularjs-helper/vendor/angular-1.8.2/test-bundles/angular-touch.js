 ...
 */
  ...
  var swipeTests = function (
    ...
    describe("ngSwipe with " + description + " events", function () {
      ...
      it("should swipe to the left", inject(function ($rootScope, $compile) {
        element = $compile('<div ng-swipe-left="swiped = true"></div>')(
          $rootScope
        );
        $rootScope.$digest();
      ...
      it("should swipe to the right", inject(function ($rootScope, $compile) {
        element = $compile('<div ng-swipe-right="swiped = true"></div>')(
          $rootScope
        );
        $rootScope.$digest();
        expect($rootScope.swiped).toBeUndefined();
      ...
      it("should only swipe given ng-swipe-disable-mouse attribute for touch events", inject(function (
        $rootScope,
        $compile
      ) {
        element = $compile(
          '<div ng-swipe-left="swiped = true" ng-swipe-disable-mouse></div>'
        )($rootScope);
        $rootScope.$digest();
        expect($rootScope.swiped).toBeUndefined();
      ...
      it("should pass event object", inject(function ($rootScope, $compile) {
        element = $compile('<div ng-swipe-left="event = $event"></div>')(
          $rootScope
        );
        $rootScope.$digest();
      ...
      it("should not swipe if you move too far vertically", inject(function (
        $rootScope,
        $compile,
        $rootElement
      ) {
      ...
      it("should not swipe if you slide only a short distance", inject(function (
        $rootScope,
        $compile,
        $rootElement
      ) {
      ...
      it("should not swipe if the swipe leaves the element", inject(function (
        $rootScope,
        $compile,
        $rootElement
      ) {
      ...
      it("should not swipe if the swipe starts outside the element", inject(function (
        $rootScope,
        $compile,
        $rootElement
      ) {
      ...
      it('should emit "swipeleft" events for left swipes', inject(function (
        $rootScope,
        $compile,
        $rootElement
      ) {
      ...
      it('should emit "swiperight" events for right swipes', inject(function (
        $rootScope,
        $compile,
        $rootElement
      ) {
  ...
  describe("$swipe", function () {
    ...
    describe("pointerTypes", function () {
      ...
      it("should use mouse, touch and pointer by default", inject(function (
        $swipe
      ) {
      ...
      it('should only use mouse events for pointerType "mouse"', inject(function (
        $swipe
      ) {
      ...
      it('should only use touch events for pointerType "touch"', inject(function (
        $swipe
      ) {
      ...
      it('should only use pointer events for pointerType "pointer"', inject(function (
        $swipe
      ) {
      ...
      it("should use mouse and touch if both are specified", inject(function (
        $swipe
      ) {
        $swipe.bind(element, events, ["touch", "mouse"]);
        expect(usedEvents.sort()).toEqual(
          MOUSE_EVENTS.concat(TOUCH_EVENTS).sort()
        );
      }));

      it("should use mouse and pointer if both are specified", inject(function (
        $swipe
      ) {
        $swipe.bind(element, events, ["mouse", "pointer"]);
        expect(usedEvents.sort()).toEqual(
          MOUSE_EVENTS.concat(POINTER_EVENTS).sort()
        );
      }));

      it("should use touch and pointer if both are specified", inject(function (
        $swipe
      ) {
        $swipe.bind(element, events, ["touch", "pointer"]);
        expect(usedEvents.sort()).toEqual(
          TOUCH_EVENTS.concat(POINTER_EVENTS).sort()
        );
      }));

      it("should use mouse, touch and pointer if they are specified", inject(function (
        $swipe
      ) {
    ...
    function swipeTests(
      ...
      describe("$swipe with " + description + " events", function () {
        ...
        it('should trigger the "move" event after a "start"', inject(function (
          $swipe
        ) {
          $swipe.bind(element, events);
        ...
        it('should not trigger a "move" without a "start"', inject(function (
          $swipe
        ) {
          $swipe.bind(element, events);
        ...
        it('should not trigger an "end" without a "start"', inject(function (
          $swipe
        ) {
          $swipe.bind(element, events);
        ...
        it('should trigger a "start", many "move"s and an "end"', inject(function (
          $swipe
        ) {
          $swipe.bind(element, events);
        ...
        it('should not start sending "move"s until enough horizontal motion is accumulated', inject(function (
          $swipe
        ) {
          $swipe.bind(element, events);
        ...
        it("should stop sending anything after vertical motion dominates", inject(function (
          $swipe
        ) {
          $swipe.bind(element, events);
