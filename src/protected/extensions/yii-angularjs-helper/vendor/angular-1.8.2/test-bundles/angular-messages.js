 ...
 */
  ...
  describe("ngMessages", function () {
    ...
    it("should render based off of a hashmap collection", inject(function (
      $rootScope,
      $compile
    ) {
      element = $compile(
    ...
    it("should render the same message if multiple message keys match", inject(function (
      $rootScope,
      $compile
    ) {
      element = $compile(
    ...
    it("should use the when attribute when an element directive is used", inject(function (
      $rootScope,
      $compile
    ) {
      element = $compile(
    ...
    it("should render the same message if multiple message keys match based on the when attribute", inject(function (
      $rootScope,
      $compile
    ) {
      element = $compile(
    ...
    it("should allow a dynamic expression to be set when ng-message-exp is used", inject(function (
      $rootScope,
      $compile
    ) {
      element = $compile(
    ...
    it("should allow a dynamic expression to be set when the when-exp attribute is used", inject(function (
      $rootScope,
      $compile
    ) {
      element = $compile(
    ...
    it("should display the elements in the order defined in the DOM", inject(function (
      $rootScope,
      $compile
    ) {
      element = $compile(
    ...
    it("should add ng-active/ng-inactive CSS classes to the element when errors are/aren't displayed", inject(function (
      $rootScope,
      $compile
    ) {
      element = $compile(
    ...
    it("should automatically re-render the messages when other directives dynamically change them", inject(function (
      $rootScope,
      $compile
    ) {
      element = $compile(
    ...
    it("should be compatible with ngBind", inject(function (
      $rootScope,
      $compile
    ) {
      element = $compile(
    ...
    // issue #12856
    it("should only detach the message object that is associated with the message node being removed", inject(function (
      $rootScope,
      $compile,
      $animate
    ) {
      ...
      it(
        ...
        function () {
          inject(function ($rootScope, $compile) {
            ...
            // Make sure removing the element triggers the deregistration in ngMessages
            expect(
              trim(deregisterSpy.calls.mostRecent().args[0].nodeValue)
            ).toBe("ngMessage: b");
            expect(messageChildren(element).length).toBe(1);
            expect(trim(element.text())).toEqual("A");
          });
    ...
    it("should clean-up the ngMessage scope when a message is removed", inject(function (
      $compile,
      $rootScope
    ) {
      var html =
    ...
    it("should unregister the ngMessage even if it was never attached", inject(function (
      $compile,
      $rootScope
    ) {
      var html =
    ...
    describe("default message", function () {
      it("should render a default message when no message matches", inject(function (
        $rootScope,
        $compile
      ) {
        element = $compile(
      ...
      it("should not render a default message with ng-messages-multiple if another error matches", inject(function (
        $rootScope,
        $compile
      ) {
        element = $compile(
      ...
      it("should handle a default message with ngIf", inject(function (
        $rootScope,
        $compile
      ) {
        element = $compile(
    ...
    describe("when including templates", function () {
      they(
        ...
        function (html) {
          inject(function ($compile, $rootScope, $templateCache) {
            ...
            html =
              '<div><div ng-repeat="item in items">' + html + "</div></div>";
            $rootScope.items = [{}, {}, {}];
      ...
      they(
        ...
        function (html) {
          inject(function ($compile, $rootScope, $templateCache) {
            ...
            var includeElement = element[0].querySelector(
      ...
      it("should cache the template after download", inject(function (
        $rootScope,
        $compile,
        $templateCache,
        $httpBackend
      ...
      it("should re-render the messages after download without an extra digest", inject(function (
        $rootScope,
        $compile,
        $httpBackend
      ) {
      ...
      it("should allow for overriding the remote template messages within the element depending on where the remote template is placed", inject(function (
        $compile,
        $rootScope,
        $templateCache
      ) {
      ...
      it("should properly detect a previous message, even if it was registered later", inject(function (
        $compile,
        $rootScope,
        $templateCache
      ) {
      ...
      it("should not throw if scope has been destroyed when template request is ready", inject(function (
        $rootScope,
        $httpBackend,
        $compile
      ) {
      ...
      it("should not throw if the template is empty", inject(function (
        $compile,
        $rootScope,
        $templateCache
      ) {
    ...
    describe("when multiple", function () {
      ...
      it("should render all truthy messages from a remote template", inject(function (
        $rootScope,
        $compile,
        $templateCache
      ) {
      ...
      it("should render and override all truthy messages from a remote template", inject(function (
        $rootScope,
        $compile,
        $templateCache
      ) {
