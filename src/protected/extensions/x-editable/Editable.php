...
class Editable extends CWidget
{
    ...
    public function registerAssets()
    {
        ...
        if ($this->type == 'select2') {
            ...
            $cs->registerCssFile(Yii::app()->theme->baseUrl . '/plugins/select2/select2.css');
            //CHANDRA 001
            //  $cs->registerScriptFile($select2Url.'/jquery.min.js');  
            //END CHANDRA 001
            //  $cs->registerScriptFile($select2Url.'/select2.min.js', CClientScript::POS_END); 

            $cs->registerScriptFile(Yii::app()->theme->baseUrl . '/plugins/select2/select2.min.js', CClientScript::POS_END);
        }
