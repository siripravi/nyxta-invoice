...
(function (e) {
  ...
  (function (e) {
    ...
    e.extend(e.fn.editableContainer.Popup.prototype, {
      ...
      show: function (t) {
        ...
        var n = e("<label>").text(
          ...
          r = e("<div>").append(n).append(this.$form);
        this.call("update", r),
          this.call("show"),
          this.tip().addClass(this.containerClass),
          this.$form.data("editableform").input.activate();
      ...
      (e.fn.editableContainer.defaults = e.extend(
        {},
        e.fn.editableContainer.defaults,
    ...
    if (e.Poshytip) {
      ...
      e.Poshytip.prototype.refresh = function (t) {
        ...
        var o = this.$tip.css("background-image").match(n),
          u = this.$arrow.css("background-image").match(n);
        if (o) {
          var a = r.test(o[1]);
          i && a
            ...
            : this.$tip
                ...
                .find(".tip-bg-image")
                .css("background-image", 'url("' + o[1] + '")')
                .end()
                .find("td")
                .eq(3)
                .append(this.$inner),
            a && !e.support.opacity && (this.opts.fade = !1);
        }
        u &&
          !e.support.opacity &&
          (i &&
            r.test(u[1]) &&
            ((u = !1), this.$arrow.css("background-image", "none")),
          (this.opts.fade = !1));
        var f = this.$tip.find("table.fallback");
        if (i) {
          (this.$tip[0].style.width = ""),
            f.width("auto").find("td").eq(3).width("auto");
          var l = this.$tip.width(),
            c = parseInt(this.$tip.css("min-width"), 10),
            h = parseInt(this.$tip.css("max-width"), 10);
          !isNaN(c) && l < c ? (l = c) : !isNaN(h) && l > h && (l = h),
            this.$tip.add(f).width(l).eq(0).find("td").eq(3).width("100%");
        } else
          f[0] &&
            f
              .width("auto")
    ...
    e.fn.editableutils.inherit(t, e.fn.editabletypes.abstractinput),
      e.extend(t.prototype, {
        initPicker: function (t, n) {
          this.options.viewformat ||
            (this.options.viewformat = this.options.format),
            (this.options.viewformat = this.options.viewformat.replace(
              "yyyy",
              "yy"
            )),
  ...
  (function (e) {
    ...
    e.fn.editableutils.inherit(t, e.fn.editabletypes.dateui),
      e.extend(t.prototype, {
        render: function () {
          this.$input.datepicker(this.options.datepicker),
            e.fn.editabletypes.text.prototype.renderClear.call(this);
        },
        value2input: function (t) {
