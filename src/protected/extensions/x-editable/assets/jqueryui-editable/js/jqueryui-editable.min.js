      ...
      initButtons: function () {
        ...
        t.append(e.fn.editableform.buttons),
          ...
          this.$form
            ...
            .button({ icons: { primary: "ui-icon-check" }, text: !1 })
            .removeAttr("title"),
          this.$form
            .find(".editable-cancel")
            .button({ icons: { primary: "ui-icon-closethick" }, text: !1 })
            .removeAttr("title");
      },
    }),
      (e.fn.editableform.errorGroupClass = null),
      (e.fn.editableform.errorBlockClass = "ui-state-error");
  })(window.jQuery),
  (function (e) {
    "use strict";
    e.extend(e.fn.editableContainer.Popup.prototype, {
      ...
      setPosition: function () {
        this.tip().position(
          e.extend({ of: this.$element }, this.containerOptions.position)
        );
      },
