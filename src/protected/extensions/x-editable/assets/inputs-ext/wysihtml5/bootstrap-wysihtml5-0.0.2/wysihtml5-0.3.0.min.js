...
window.rangy = (function () {
  ...
  var h = "object",
    ...
    j = "undefined",
    n =
      "startContainer startOffset endContainer endOffset collapsed commonAncestorContainer START_TO_START START_TO_END END_TO_START END_TO_END".split(
        " "
      ),
    p =
    ...
    r =
      "collapse compareEndPoints duplicate getBookmark moveToBookmark moveToElementText parentElement pasteHTML select setEndPoint getBoundingClientRect".split(
        " "
      ),
    m = d(b),
    s = d(c),
  ...
  o.warn = function (a) {
    a = "Rangy warning: " + a;
    o.config.alertOnWarn
      ? window.alert(a)
      : typeof window.console != j &&
        typeof window.console.log != j &&
        window.console.log(a);
  };
  ({}).hasOwnProperty
    ? (o.util.extend = function (a, b) {
...
rangy.createModule("DomUtil", function (b, c) {
  ...
  var p = "undefined",
    q = b.util;
  q.areHostMethods(document, [
    "createDocumentFragment",
    "createElement",
    "createTextNode",
  ]) || c.fail("document missing a Node creation method");
  q.isHostMethod(document, "getElementsByTagName") ||
    c.fail("document missing getElementsByTagName method");
  var r = document.createElement("div");
  q.areHostMethods(r, ["insertBefore", "appendChild", "cloneNode"]) ||
    c.fail("Incomplete Element implementation");
  q.isHostProperty(r, "innerHTML") ||
    c.fail("Element is missing innerHTML property");
  ...
  q.areHostMethods(r, [
    ...
    "appendData",
    "cloneNode",
  ]) || c.fail("Incomplete Text Node implementation");
  var m = function (a, b) {
...
rangy.createModule("DomRange", function (b) {
  ...
  function k(a) {
    for (var b; a.next(); )
      a.isPartiallySelectedSubtree()
        ? ((b = a.getSubtreeIterator()), k(b), b.detach(!0))
        : a.remove();
  }
  function j(b) {
  ...
  function v(a) {
    o(a);
    if (
      (!l.arrayContains(G, a.startContainer.nodeType) &&
        !O(a.startContainer, !0)) ||
      (!l.arrayContains(G, a.endContainer.nodeType) &&
        !O(a.endContainer, !0)) ||
      !(
        a.startOffset <=
  ...
  function E(a, b) {
    return function () {
      ...
      var c = this.startContainer,
        ...
        j = new q(this, !0);
      c !== e &&
        ((c = l.getClosestAncestorIn(c, e, !0)),
        (d = f(c)),
        (c = d.node),
        (d = d.offset));
      h(j, A);
    ...
    b.util.extend(a.prototype, {
      ...
      splitBoundaries: function () {
        ...
        l.isCharacterDataNode(a) &&
          ...
          e
            ? ((h -= b), (c = a))
            : c == a.parentNode && h >= l.getNodeIndex(a) && h++,
          (b = 0));
        d(this, a, b, c, h);
      },
  ...
  D.prototype = {
    ...
    comparePoint: function (a, b) {
      ...
      return 0 > l.comparePoints(a, b, this.startContainer, this.startOffset)
        ? -1
    ...
    createContextualFragment: S
      ? function (a) {
          ...
          1 == b.nodeType
            ? (d = b)
            : l.isCharacterDataNode(b) && (d = l.parentElement(b));
          d =
            null === d ||
            ("HTML" == d.nodeName &&
              l.isHtmlNamespace(l.getDocument(d).documentElement) &&
              l.isHtmlNamespace(d))
    ...
    isPointInRange: function (a, b) {
      ...
      y(a, this.startContainer);
      return (
        0 <= l.comparePoints(a, b, this.startContainer, this.startOffset) &&
        0 >= l.comparePoints(a, b, this.endContainer, this.endOffset)
      );
    },
    ...
    containsNodeContents: function (a) {
      return (
        0 <= this.comparePoint(a, 0) &&
        0 >= this.comparePoint(a, l.getNodeLength(a))
      );
    },
...
rangy.createModule("WrappedRange", function (b) {
  function c(a, b, c, d) {
    ...
    if (-1 == r && m && e.isCharacterDataNode(m)) {
      ...
      if (/[\r\n]/.test(m.data)) {
        ...
        c = i.text.replace(/\r\n/g, "\r").length;
        for (
          c = i.moveStart("character", c);
          -1 == i.compareEndPoints("StartToEnd", i);
  ...
  var d,
    ...
    g = b.DomRange;
  if (
    b.features.implementsDomRange &&
    (!b.features.implementsTextRange || !b.config.preferTextRange)
  )
    (function () {
      function a(b) {
      ...
      c.compareBoundaryPoints =
        (-1 == q.compareBoundaryPoints(q.START_TO_END, f)) &
        (1 == q.compareBoundaryPoints(q.END_TO_START, f))
          ? function (a, b) {
              b = b.nativeRange || b;
              a == b.START_TO_END
                ? (a = b.END_TO_START)
      ...
      b.util.isHostMethod(q, "createContextualFragment") &&
    ...
    d.prototype.refresh = function () {
      ...
      0 == this.textRange.compareEndPoints("StartToEnd", this.textRange)
        ? (b = a = c(this.textRange, b, !0, !0))
        : ((a = c(this.textRange, b, !0, !1)),
  ...
  b.features.implementsTextRange &&
    (d.rangeToTextRange = function (b) {
...
rangy.createModule("WrappedSelection", function (b, c) {
  ...
  function g(a) {
    var c;
    a instanceof x
      ? ((c = a._selectionNativeRange),
        c ||
          ((c = b.createNativeRange(m.getDocument(a.startContainer))),
          c.setEnd(a.endContainer, a.endOffset),
          c.setStart(a.startContainer, a.startOffset),
          (a._selectionNativeRange = c),
      ...
      ? (c = a.nativeRange)
      : b.features.implementsDomRange &&
        a instanceof m.getWindow(a.startContainer).Range &&
        (c = a);
    return c;
  }
  function i(a) {
    ...
    if ("None" == a.docSelection.type) f(a);
      ...
      if (c && "undefined" != typeof c.text) h(a, c);
        ...
        for (var d, j = m.getDocument(c.item(0)), k = 0; k < a.rangeCount; ++k)
          (d = b.createRange(j)), d.selectNode(c.item(k)), a._ranges.push(d);
  ...
  function j(a, b) {
    for (
      var c = a.docSelection.createRange(),
        d = i(b),
        e = m.getDocument(c.item(0)),
        e = m.getBody(e).createControlRange(),
        h = 0,
        j = c.length;
      h < j;
      ++h
  ...
  function p(a, b) {
    for (
      var c = m.getDocument(b[0].startContainer),
        c = m.getBody(c).createControlRange(),
        d = 0,
        e;
      d < rangeCount;
      ++d
  ...
  D
    ? ((y = d),
      (b.isSelectionValid = function (a) {
        var a = (a || window).document,
          b = a.selection;
        return (
          "None" != b.type ||
          m.getDocument(b.createRange().parentElement()) == a
        );
      }))
    : t
    ? ((y = a),
      (b.isSelectionValid = function () {
        return !0;
      }))
  ...
  var t = y(),
    ...
    E = s.areHostObjects(
      t,
      s.areHostProperties(t, ["anchorOffset", "focusOffset"])
    );
  ...
  var J = !1,
    C = !0;
  s.areHostMethods(t, ["addRange", "getRangeAt", "removeAllRanges"]) &&
    "number" == typeof t.rangeCount &&
    b.features.implementsDomRange &&
    (function () {
  ...
  var l = !1,
    u;
  F &&
    s.isHostMethod(F, "createControlRange") &&
    ((u = F.createControlRange()),
    s.areHostProperties(u, ["item", "add"]) && (l = !0));
  ...
  if (!D && E && s.areHostMethods(t, ["removeAllRanges", "addRange"])) {
          ...
          if (l && v && this.docSelection.type == "Control") j(this, a);
            ...
            if (this.rangeCount == d + 1) {
              if (b.config.checkSelectionRanges)
                (d = B(this.nativeSelection, this.rangeCount - 1)) &&
                  !x.rangesEqual(d, a) &&
                  (a = new o(d));
    ...
    s.isHostMethod(t, "empty") &&
    s.isHostMethod(K, "select") &&
    l &&
    D
  )
    (u.removeAllRanges = function () {
  ...
  if (D)
    ...
    E &&
    "boolean" == typeof t.isCollapsed &&
    "boolean" == typeof K.collapsed &&
    b.features.implementsDomRange
  )
    G = function (a) {
      var b;
  ...
  var H;
  !D && E && b.features.implementsDomRange
    ? ((H = function (a) {
        var b = false;
        a.anchorNode &&
          (b =
...
wysihtml5.browser = (function () {
  ...
  return {
          ...
          (this.isIos() &&
            5 >
              ((/ipad|iphone|ipod/.test(a) &&
                a.match(/ os (\d+).+? like mac os x/)) || [, 0])[1]) ||
    ...
    supportsSpeechApiOn: function (a) {
      return (
        11 <= (b.match(/Chrome\/(\d+)/) || [, 0])[1] &&
        ("onwebkitspeechchange" in a || "speech" in a)
      );
    },
...
wysihtml5.lang.array = function (b) {
  return {
    ...
    without: function (c) {
      for (
        var c = wysihtml5.lang.array(c), a = [], d = 0, e = b.length;
        d < e;
        d++
      )
...
(function (b) {
  ...
  a.hasClass = function (a, b) {
    ...
    var f = a.className;
    return (
      0 < f.length && (f == b || RegExp("(^|\\s)" + b + "(\\s|$)").test(f))
    );
  };
})(wysihtml5);
...
wysihtml5.dom.convertToList = (function () {
  ...
  return function (c, a) {
    ...
    for (n = 0; n < g; n++)
      (j = j || b(d, e)),
        (i = f[n]),
        (h = "block" === wysihtml5.dom.getStyle("display").from(i)),
        (k = "BR" === i.nodeName),
        h
          ? ((j = j.firstChild ? b(d, e) : j), j.appendChild(i), (j = null))
          : k
          ? (j = j.firstChild ? null : j)
          : j.appendChild(i);
      ...
      return {
        to: function (a) {
          for (var d, e = 0, f = b.length; e < f; e++)
            (d = b[e]),
              "undefined" !== typeof c[d] && "" !== c[d] && (a[d] = c[d]);
...
(function (b) {
  b.dom.delegate = function (c, a, d, e) {
    return b.dom.observe(c, d, function (d) {
      for (
        var g = d.target, i = b.lang.array(c.querySelectorAll(a));
        g && g !== c;
...
wysihtml5.dom.getAsDom = (function () {
  var b =
    "abbr article aside audio bdi canvas command datalist details figcaption figure footer header hgroup keygen mark meter nav output progress rp rt ruby svg section source summary time track video wbr".split(
      " "
    );
  return function (c, a) {
    var a = a || document,
...
wysihtml5.dom.getParentElement = (function () {
  function b(b, a) {
    return !a || !a.length
      ...
      : "string" === typeof a
      ? b === a
      : wysihtml5.lang.array(a).contains(b);
  }
  return function (c, a, d) {
    ...
    if (a.className || a.classRegExp) {
      a: {
        for (
          var e = a.nodeName, f = a.className, a = a.classRegExp;
          d-- && c && "BODY" !== c.nodeName;
      ...
      from: function (e) {
        if (e.nodeType === wysihtml5.ELEMENT_NODE) {
          ...
          if (g.getComputedStyle)
            return (
              f && ((n = i.overflow), (i.overflow = "hidden")),
              (e = g.getComputedStyle(e, null).getPropertyValue(a)),
              f && (i.overflow = n || ""),
              e
            );
        }
...
wysihtml5.dom.hasElementWithTagName = (function () {
  ...
  return function (a, d) {
    var e =
        (a._wysihtml5_identifier || (a._wysihtml5_identifier = c++)) + ":" + d,
      f = b[e];
...
(function (b) {
  ...
  b.dom.hasElementWithClassName = function (d, e) {
    ...
    var f =
        (d._wysihtml5_identifier || (d._wysihtml5_identifier = a++)) + ":" + e,
      g = c[f];
...
wysihtml5.dom.observe = function (b, c, a) {
  for (
    var c = "string" === typeof c ? [c] : c, d, e, f = 0, g = c.length;
    f < g;
    f++
  )
    (e = c[f]),
      b.addEventListener
        ? b.addEventListener(e, a, !1)
        : ((d = function (c) {
...
wysihtml5.dom.parse = (function () {
  ...
  function c(a, b) {
    ...
    return c
      ? a.src
      : i && "outerHTML" in a
      ? -1 != a.outerHTML.toLowerCase().indexOf(" " + b + "=")
        ? a.getAttribute(b)
        : null
      : a.getAttribute(b);
  }
  var a = {
      1: function (a) {
        ...
        } else if (a.firstChild) b = { rename_tag: d };
        else return null;
        ...
        i.src &&
          ("undefined" !== typeof i.width && f.setAttribute("width", i.width),
          "undefined" !== typeof i.height &&
            f.setAttribute("height", i.height));
        return f;
      },
      3: function (a) {
  ...
  return function (a, c, d, e) {
    ...
    for (
      var d = d || a.ownerDocument || document,
        c = d.createDocumentFragment(),
        h = "string" === typeof a,
        a = h ? wysihtml5.dom.getAsDom(a, d) : a;
      a.firstChild;
...
wysihtml5.dom.removeEmptyTextNodes = function (b) {
  for (
    var c = wysihtml5.lang.array(b.childNodes).get(), a = c.length, d = 0;
    d < a;
    d++
  )
    (b = c[d]),
...
(function (b) {
  ...
  b.resolveList = function (a) {
    if (
      !("MENU" !== a.nodeName && "UL" !== a.nodeName && "OL" !== a.nodeName)
    ) {
      var d = a.ownerDocument.createDocumentFragment(),
        ...
        i;
      for (
        e && "block" !== b.getStyle("display").from(e) && c(d);
        (i = a.firstChild);
        ...
        for (f = i.lastChild; (e = i.firstChild); )
          (g =
            (g = e === f) &&
            "block" !== b.getStyle("display").from(e) &&
            "BR" !== e.nodeName),
            d.appendChild(e),
            g && c(d);
...
(function (b) {
  var c = document,
    a =
      "parent top opener frameElement frames localStorage globalStorage sessionStorage indexedDB".split(
        " "
      ),
    d =
      "open close openDialog showModalDialog alert confirm prompt openDatabase postMessage XMLHttpRequest XDomainRequest".split(
        " "
      ),
  ...
  b.dom.Sandbox = Base.extend({
    ...
    _createIframe: function () {
      ...
      b.dom
        ...
        .on(d);
      b.browser.throwsMixedContentWarningWhenIframeSrcIsEmpty() &&
  ...
  return {
    on: function (c) {
      ...
      if ("string" === typeof b) c.cssText += ";" + b;
        ...
        for (var a in b)
          "float" === a
            ? ((c.cssFloat = b[a]), (c.styleFloat = b[a]))
            : (c[a] = b[a]);
    },
  };
};
(function (b) {
  b.simulatePlaceholder = function (c, a, d) {
    ...
    c.observe("set_placeholder", f)
      .observe("unset_placeholder", e)
      .observe("focus:composer", e)
      .observe("paste:composer", e)
      .observe("blur:composer", f);
    f();
  };
})(wysihtml5.dom);
(function (b) {
      ...
      c.observe(d.element, "keydown", function (e) {
        if (e.keyCode === b.BACKSPACE_KEY) {
          var f = d.selection.getSelectedNode(),
            e = d.element;
          e.firstChild &&
            b.lang.array(a).contains(e.firstChild.nodeName) &&
            (f = c.getParentElement(f, { nodeName: a })) &&
            f == e.firstChild &&
            1 >= f.childNodes.length &&
            (f.firstChild ? "" === f.firstChild.innerHTML : 1) &&
...
(function (b) {
  b.quirks.getCorrectInnerHTML = function (c) {
    ...
    for (f = c.length; g < f; g++)
      (d = c[g].href || c[g].src),
        (e = b.lang.string(d).replace("~").by("%7E")),
  ...
  b.quirks.insertLineBreakOnReturn = function (e) {
    ...
    c.observe(e.element.ownerDocument, "keydown", function (g) {
      ...
      if (!(g.shiftKey || (i !== b.ENTER_KEY && i !== b.BACKSPACE_KEY))) {
        ...
        (h = c.getParentElement(h, { nodeName: a }, 4))
          ? "LI" === h.nodeName && (i === b.ENTER_KEY || i === b.BACKSPACE_KEY)
            ? setTimeout(function () {
                var a = e.selection.getSelectedNode(),
                  b;
                a && ((b = c.getParentElement(a, { nodeName: d }, 2)) || f(a));
              }, 0)
            : h.nodeName.match(/H[1-6]/) &&
              i === b.ENTER_KEY &&
              setTimeout(function () {
                f(e.selection.getSelectedNode());
              }, 0)
          : i === b.ENTER_KEY &&
            !b.browser.insertsLineBreaksOnReturn() &&
            (e.commands.exec("insertLineBreak"), g.preventDefault());
      }
    });
  };
})(wysihtml5);
...
(function (b) {
  ...
  b.Selection = Base.extend({
    ...
    selectNode: function (a) {
      ...
      f && g && e
        ? d.collapse(i)
        : f && g && (d.setStartAfter(a), d.setEndAfter(a));
      this.setSelection(d);
    },
    getSelectedNode: function (a) {
      if (
        ...
        (a = this.doc.selection.createRange()) &&
        a.length
      )
        return a.item(0);
      a = this.getSelection(this.doc);
      return a.focusNode === a.anchorNode
        ? a.focusNode
    ...
    executeAndRestore: function (a, c) {
      ...
      if (h) {
        ...
        (caretPlaceholder = this.doc.querySelector(
          "._wysihtml5-temp-placeholder"
        ))
          ? ((h = rangy.createRange(this.doc)),
            h.selectNode(caretPlaceholder),
            h.deleteContents(),
            this.setSelection(h))
          : e.focus();
    ...
    selectLine: function () {
      b.browser.supportsSelectionModify()
    ...
    setSelection: function (a) {
      return rangy
        .getSelection(this.doc.defaultView || this.doc.parentWindow)
        .setSingleRange(a);
    },
  });
})(wysihtml5);
(function (b, c) {
  function a(a, b) {
    return c.dom.isCharacterDataNode(a)
      ? 0 == b
        ? !!a.previousSibling
        : b == a.length
        ? !!a.nextSibling
        : !0
      : 0 < b && b < a.childNodes.length;
  }
  function d(a, b, e) {
    var f;
    c.dom.isCharacterDataNode(b) &&
      (0 == e
        ? ((e = c.dom.getNodeIndex(b)), (b = b.parentNode))
        : e == b.length
        ? ((e = c.dom.getNodeIndex(b) + 1), (b = b.parentNode))
        : (f = c.dom.splitDataNode(b, e)));
    if (!f) {
      f = b.cloneNode(!1);
  ...
  function e(a) {
    this.firstTextNode = (this.isElementMerge = a.nodeType == b.ELEMENT_NODE)
      ? a.lastChild
      : a;
  ...
  f.prototype = {
    getAncestorWithClass: function (a) {
      for (var d; a; ) {
        ...
        if (
          a.nodeType == b.ELEMENT_NODE &&
          c.dom.arrayContains(this.tagNames, a.tagName.toLowerCase()) &&
          d
        )
          return a;
        a = a.parentNode;
    ...
    postApply: function (a, b) {
      for (
        ...
        if (
          ...
          if (
            (g || ((g = new e(z)), f.push(g)),
            g.textNodes.push(o),
            o === c && ((i = g.firstTextNode), (s = i.length)),
            o === d)
          )
      ...
      if (
        ...
        if (
          ...
          if ((d = a.className.replace(i, " ") == b.className.replace(i, " ")))
            a: if (a.attributes.length != b.attributes.length) d = !1;
            else {
              d = 0;
              for (var e = a.attributes.length, f, g; d < e; ++d)
                if (
                  ...
                  (g = f.name),
                  "class" != g &&
                    ((g = b.attributes.getNamedItem(g)),
                    f.specified != g.specified ||
                      (f.specified && f.nodeValue !== g.nodeValue)))
                ) {
                  d = !1;
                  break a;
                }
    ...
    applyToTextNode: function (a) {
      ...
      c.dom.arrayContains(this.tagNames, b.tagName.toLowerCase())
        ? this.cssClass &&
          ((a = this.cssClass),
          b.className
            ? (b.className &&
              ...
              (b.className += " " + a))
            : (b.className = a))
        : ((b = this.createContainer(c.dom.getDocument(a))),
    ...
    isRemovable: function (a) {
      return (
        c.dom.arrayContains(this.tagNames, a.tagName.toLowerCase()) &&
        b.lang.string(a.className).trim() == this.cssClass
      );
    },
    undoToTextNode: function (b, c, e) {
      c.containsNode(e) ||
        ((b = c.cloneRange()),
        b.selectNode(e),
        b.isPointInRange(c.endContainer, c.endOffset) &&
          a(c.endContainer, c.endOffset) &&
          (d(e, c.endContainer, c.endOffset), c.setEndAfter(e)),
        b.isPointInRange(c.startContainer, c.startOffset) &&
          a(c.startContainer, c.startOffset) &&
          (e = d(e, c.startContainer, c.startOffset)));
      this.similarClassRegExp &&
        e.className &&
        (e.className = e.className.replace(this.similarClassRegExp, ""));
    ...
    undoToRange: function (a) {
      var c = a.getNodes([b.TEXT_NODE]),
        ...
        e;
      c.length
        ? (a.splitBoundaries(), (c = a.getNodes([b.TEXT_NODE])))
        : ((c = a.endContainer.ownerDocument.createTextNode(b.INVISIBLE_SPACE)),
          a.insertNode(c),
          a.selectNode(c),
          (c = [c]));
      for (var f = 0, g = c.length; f < g; ++f)
        (d = c[f]),
          (e = this.getAncestorWithClass(d)) && this.undoToTextNode(d, a, e);
      1 == g
        ? this.selectNode(a, c[0])
        : (a.setStart(c[0], 0),
          (d = c[c.length - 1]),
          a.setEnd(d, d.length),
          this.normalize && this.postApply(c, a));
...
(function (b) {
  function c(c, g) {
    ...
    k = n;
    1 === h &&
      ((p = e.getTextContent(n)),
      (h = !!n.querySelector("*")),
      (p = "" === p || p === b.INVISIBLE_SPACE),
      !h &&
        p &&
        (e.setTextContent(n, g.text || n.href),
        (i = i.createTextNode(" ")),
        c.selection.setAfter(n),
      ...
      h
        ? a.selection.executeAndRestore(function () {
            for (var a = h.length, b = 0, c, d, f; b < a; b++)
              (c = h[b]),
                (d = e.getParentElement(c, { nodeName: "code" })),
                (f = e.getTextContent(c)),
                f.match(e.autoLink.URL_REG_EXP) && !d
                  ? e.renameElement(c, "code")
                  : e.replaceWithChildNodes(c);
          })
...
(function (b) {
  ...
  b.commands.fontSize = {
    exec: function (a, d, e) {
      return b.commands.formatInline.exec(
        a,
        d,
        "span",
        "wysiwyg-font-size-" + e,
    ...
    state: function (a, d, e) {
      return b.commands.formatInline.state(
        a,
        d,
        "span",
        "wysiwyg-font-size-" + e,
...
(function (b) {
  function c(a) {
    for (
      a = a.previousSibling;
      a && a.nodeType === b.TEXT_NODE && !b.lang.string(a.data).trim();
  ...
  function d(a) {
    return "BR" === a.nodeName || "block" === g.getStyle("display").from(a)
      ? !0
      : !1;
  }
  function e(a, c, d, e) {
    if (e)
      var f = g.observe(a, "DOMNodeInserted", function (a) {
        var a = a.target,
          c;
        a.nodeType === b.ELEMENT_NODE &&
          ((c = g.getStyle("display").from(a)),
          "inline" !== c.substr(0, 6) && (a.className += " " + e));
      });
    a.execCommand(c, !1, d);
    f && f.stop();
  }
  ...
  b.commands.formatBlock = {
    exec: function (h, k, j, n, p) {
      var q = h.doc,
        ...
        m,
        j = "string" === typeof j ? j.toUpperCase() : j;
      if (r)
          ...
          if (
            ...
            h.selection.executeAndRestoreSimple(function () {
              ...
              if (n) {
                var a = r;
                a.className
                  ? ((a.className = a.className.replace(p, "")),
                    (a.className += " " + n))
                  : (a.className = n);
              }
            });
        ...
        h.commands.support(k)
          ? e(q, k, j || "DIV", n)
          : ((r = q.createElement(j || "DIV")),
            n && (r.className = n),
            f(h, r));
      }
    },
...
(function (b) {
  ...
  var a = { strong: "b", em: "i", b: "strong", i: "em" },
    d = {};
  b.commands.formatInline = {
    ...
    state: function (d, f, g, i, h) {
      var f = d.doc,
        k = a[g] || g;
      if (
        (!b.dom.hasElementWithTagName(f, g) &&
          !b.dom.hasElementWithTagName(f, k)) ||
        (i && !b.dom.hasElementWithClassName(f, i))
      )
        return !1;
...
(function (b) {
  b.commands.insertHTML = {
    exec: function (b, a, d) {
      b.commands.support(a)
        ? b.doc.execCommand(a, !1, d)
        : b.selection.insertHTML(d);
    },
    state: function () {
      return !1;
    },
...
(function (b) {
  b.commands.insertImage = {
    exec: function (c, a, d) {
      var d = "object" === typeof d ? d : { src: d },
        e = c.doc,
        a = this.state(c),
        f;
      if (a)
        c.selection.setBefore(a),
          (d = a.parentNode),
          d.removeChild(a),
          b.dom.removeEmptyTextNodes(d),
          "A" === d.nodeName &&
            !d.firstChild &&
            (c.selection.setAfter(d), d.parentNode.removeChild(d)),
          b.quirks.redraw(c.element);
      else {
        a = e.createElement("IMG");
        for (f in d) a[f] = d[f];
        c.selection.insertNode(a);
        b.browser.hasProblemsSettingCaretAfterImg()
          ? ((d = e.createTextNode(b.INVISIBLE_SPACE)),
            c.selection.insertNode(d),
...
(function (b) {
  ...
  b.commands.insertLineBreak = {
    exec: function (a, d) {
      a.commands.support(d)
        ? (a.doc.execCommand(d, !1, null),
          b.browser.autoScrollsToCaret() || a.selection.scrollIntoView())
        : a.commands.exec("insertHTML", c);
    },
    state: function () {
      return !1;
    },
  ...
  b.commands.insertOrderedList = {
    exec: function (c, a) {
      var d = c.doc,
        ...
        f = b.dom.getParentElement(e, { nodeName: "OL" }),
        g = b.dom.getParentElement(e, { nodeName: "UL" }),
        e = "_wysihtml5-temp-" + new Date().getTime(),
        i;
      c.commands.support(a)
        ? d.execCommand(a, !1, null)
        : f
        ...
        : (c.commands.exec("formatBlock", "div", e),
          (i = d.querySelector("." + e)),
          (d = "" === i.innerHTML || i.innerHTML === b.INVISIBLE_SPACE),
          c.selection.executeAndRestoreSimple(function () {
...
(function (b) {
  b.commands.insertUnorderedList = {
    exec: function (c, a) {
      var d = c.doc,
        e = c.selection.getSelectedNode(),
        f = b.dom.getParentElement(e, { nodeName: "UL" }),
        g = b.dom.getParentElement(e, { nodeName: "OL" }),
        e = "_wysihtml5-temp-" + new Date().getTime(),
        i;
      c.commands.support(a)
        ? d.execCommand(a, !1, null)
...
(function (b) {
  ...
  b.commands.justifyCenter = {
    exec: function (a) {
      return b.commands.formatBlock.exec(
        a,
        "formatBlock",
        null,
    ...
    state: function (a) {
      return b.commands.formatBlock.state(
        a,
        "formatBlock",
        null,
        "wysiwyg-text-align-center",
    ...
    _observe: function () {
      ...
      d.observe(this.element, "keydown", function (a) {
        if (!(a.altKey || (!a.ctrlKey && !a.metaKey))) {
          ...
          90 === b && !a.shiftKey
            ? (e.undo(), a.preventDefault())
            : c && (e.redo(), a.preventDefault());
        }
      });
      d.observe(this.element, "keydown", function (a) {
        a = a.keyCode;
      ...
      if (b.browser.hasUndoInContextMenu()) {
        ...
        d.observe(this.element, "contextmenu", function () {
          ...
          i = setInterval(function () {
            f.getElementById("_wysihtml5-redo")
              ? (k(), e.redo())
              : f.getElementById("_wysihtml5-undo") || (k(), e.undo());
          }, 400);
          h ||
            ((h = !0),
            d.observe(document, "mousedown", k),
            d.observe(f, ["mousedown", "paste", "cut", "copy"], k));
        });
      }
      this.editor
...
(function (b) {
  ...
  b.views.Composer = b.views.View.extend({
    ...
    clear: function () {
      this.element.innerHTML = a.displaysCaretInEmptyContentEditableCorrectly()
        ? ""
        : this.CARET_HACK;
    },
    getValue: function (a) {
    ...
    _create: function () {
      ...
      c.copyAttributes(
        "className spellcheck title lang dir accessKey".split(" ")
      )
      ...
      (e =
        "string" === typeof this.config.placeholder
          ...
          : this.textarea.element.getAttribute("placeholder")) &&
        c.simulatePlaceholder(this.parent, this, e);
      ...
      a.clearsListsInContentEditableCorrectly() ||
        b.quirks.ensureProperClearingOfLists(this);
        ...
        c.observe(this.element, "keydown", function (a) {
          if (g.length) {
            var a = d.selection.getSelectedNode(a.target.ownerDocument),
              b = c.getParentElement(a, { nodeName: "A" }, 4),
              e;
            b &&
              ((e = h(b)),
              setTimeout(function () {
    ...
    _initObjectResizing: function () {
      ...
      this.config.allowObjectResizing
        ? a.supportsEvent("resizeend") &&
          c.observe(f, "resizeend", function (a) {
            for (
              var a = a.target || a.srcElement, c = a.style, h = 0, k;
              h < e;
              h++
            )
              (k = d[h]),
        ...
        : a.supportsEvent("resizestart") &&
          c.observe(f, "resizestart", function (a) {
            a.preventDefault();
          });
    },
...
(function (b) {
  var c = b.dom,
    ...
    f =
      "background-color color cursor font-family font-size font-style font-variant font-weight line-height letter-spacing text-align text-decoration text-indent text-rendering word-break word-wrap word-spacing".split(
        " "
      ),
    g =
      ...
      var s = c.observe(d, "resize", function () {
        if (c.contains(document.documentElement, j.iframe)) {
          ...
          c.copyStyles(i)
            .from(p)
            .to(j.iframe)
            .andTo(j.focusStylesHost)
            .andTo(j.blurStylesHost);
...
(function (b) {
  ...
  b.views.Composer.prototype.observe = function () {
    ...
    var j = setInterval(function () {
      c.contains(document.documentElement, g) ||
        (clearInterval(j), e.parent.fire("destroy:composer"));
    }, 250);
    ...
    a.firesOnDropOnlyWhenOnDragOverIsCancelled() &&
      c.observe(i, ["dragover", "dragenter"], function (a) {
        a.preventDefault();
      });
    c.observe(i, k, function (b) {
      var c = b.dataTransfer,
        d;
      c &&
        a.supportsDataTransfer() &&
        (d = c.getData("text/html") || c.getData("text/plain"));
      d
        ? (i.focus(),
          e.commands.exec("insertHTML", d),
    ...
    a.canSelectImagesInContentEditable() ||
      c.observe(i, "mousedown", function (a) {
        var b = a.target;
    ...
    c.observe(i, "keydown", function (a) {
      ...
      if (
        c &&
        "IMG" === c.nodeName &&
        (d === b.BACKSPACE_KEY || d === b.DELETE_KEY)
      )
        (d = c.parentNode),
          d.removeChild(c),
          "A" === d.nodeName && !d.firstChild && d.parentNode.removeChild(d),
          setTimeout(function () {
            b.quirks.redraw(i);
          }, 0),
          a.preventDefault();
    ...
    c.observe(i, "mouseover", function (a) {
      ...
      !("A" !== b && "IMG" !== b) &&
        ...
        ((b = n[b] + (a.getAttribute("href") || a.getAttribute("src"))),
    ...
    _observe: function () {
      if (!this._observed) {
        ...
        c.observe(a.link, "click", function () {
          c.hasClass(a.link, "wysihtml5-command-dialog-opened") &&
            setTimeout(function () {
              a.hide();
            }, 0);
        });
        ...
        for (
          var e = this.container.querySelectorAll("input, select, textarea"),
            f = 0,
            g = e.length,
            i = function () {
    ...
    _serialize: function () {
      for (
        var a = this.elementToChange || {},
          b = this.container.querySelectorAll("[data-wysihtml5-dialog-field]"),
          c = b.length,
          f = 0;
        f < c;
        f++
    ...
    _interpolate: function (a) {
      for (
        var b,
          ...
          g = this.container.querySelectorAll("[data-wysihtml5-dialog-field]"),
          i = g.length,
          h = 0;
        h < i;
        h++
        ...
        (b = g[h]),
          b !== f &&
            !(a && "hidden" === b.type) &&
            ((c = b.getAttribute("data-wysihtml5-dialog-field")),
            (c = this.elementToChange
              ? this.elementToChange[c] || ""
              : b.defaultValue),
            (b.value = c));
    },
    show: function (a) {
...
(function (b) {
  ...
  b.toolbar.Speech = function (g, i) {
    ...
    if (b.browser.supportsSpeechApiOn(h)) {
      ...
      b.lang
        .object(d)
        .merge({ width: i.offsetWidth + "px", height: i.offsetHeight + "px" });
      c.insert(h).into(k);
      c.insert(k).into(i);
      c.setStyles(e).on(h);
      ...
      c.observe(
        h,
        "onwebkitspeechchange" in h ? "webkitspeechchange" : "speechchange",
        function () {
...
(function (b) {
  ...
  b.toolbar.Toolbar = Base.extend({
    ...
    _getLinks: function (a) {
      for (
        var c = (this[a + "Links"] = b.lang
            .array(
              this.container.querySelectorAll("[data-wysihtml5-" + a + "]")
            )
            .get()),
          e = c.length,
          f = 0,
        ...
        (i = c[f]),
          (k = i.getAttribute("data-wysihtml5-" + a)),
          (j = i.getAttribute("data-wysihtml5-" + a + "-value")),
          (h = this.container.querySelector(
            "[data-wysihtml5-" + a + "-group='" + k + "']"
          )),
          (n = this._getDialog(i, k)),
          (g[k + ":" + j] = {
            link: i,
            group: h,
            name: k,
    ...
    _getDialog: function (a, c) {
      var e = this,
        ...
        i;
      f &&
        ((g = new b.toolbar.Dialog(a, f)),
        g.observe("show", function () {
    ...
    _observe: function () {
      for (
        var a = this,
          b = this.editor,
          e = this.container,
          f = this.commandLinks.concat(this.actionLinks),
          g = f.length,
          i = 0;
        i < g;
        i++
      ...
      b.observe("change_view", function (b) {
        setTimeout(function () {
          ...
          a._updateLinkstates();
          a.commandsDisabled
            ? c.addClass(e, "wysihtml5-commands-disabled")
      ...
      for (e in a)
        if (
          ...
          this.commandsDisabled
            ? ((f = !1),
              c.removeClass(g.link, "wysihtml5-command-active"),
              g.group && c.removeClass(g.group, "wysihtml5-command-active"),
              g.dialog && g.dialog.hide())
            : ((f = this.composer.commands.state(g.name, g.value)),
              b.lang.object(f).isArray() && (f = 1 === f.length ? f[0] : !0),
              c.removeClass(g.link, "wysihtml5-command-disabled"),
              g.group && c.removeClass(g.group, "wysihtml5-command-disabled")),
          g.state !== f)
        )
          (g.state = f)
            ? (c.addClass(g.link, "wysihtml5-command-active"),
              g.group && c.addClass(g.group, "wysihtml5-command-active"),
              g.dialog &&
                ("object" === typeof f ? g.dialog.show(f) : g.dialog.hide()))
            : (c.removeClass(g.link, "wysihtml5-command-active"),
              g.group && c.removeClass(g.group, "wysihtml5-command-active"),
              g.dialog && g.dialog.hide());
      for (e in d)
        (a = d[e]),
          "change_view" === a.name &&
            ((a.state = this.editor.currentView === this.editor.textarea),
            a.state
              ? c.addClass(a.link, "wysihtml5-action-active")
              : c.removeClass(a.link, "wysihtml5-action-active"));
    },
    show: function () {
      this.container.style.display = "";
    },
...
(function (b) {
  ...
  b.Editor = b.lang.Dispatcher.extend({
    constructor: function (a, d) {
      ...
      this.currentView = this.textarea = new b.views.Textarea(
        this,
        this.textareaElement,
        this.config
      );
      ...
      if (
        !this._isCompatible ||
        (!this.config.supportTouchDevices && b.browser.isTouchDevice())
      ) {
        var e = this;
        setTimeout(function () {
        ...
        this.currentView = this.composer = new b.views.Composer(
          this,
          this.textareaElement,
          this.config
        );
        ...
        this.observe("beforeload", function () {
          this.synchronizer = new b.views.Synchronizer(
            this,
            this.textarea,
            this.composer
          );
          this.config.toolbar &&
            (this.toolbar = new b.toolbar.Toolbar(this, this.config.toolbar));
        });
        try {
          console.log(
