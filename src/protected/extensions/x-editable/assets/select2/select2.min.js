    ...
    a.fn.extend({
      each2: function (b) {
        for (
          ...
          e > ++d && (c.context = c[0] = this[d]) && b.call(c[0], d, c) !== !1;
        ...
        window.clearTimeout(d),
          (d = window.setTimeout(function () {
            ...
            (g = g ? g.call(i, j.term, j.page, j.context) : null),
              (k =
                "function" == typeof k
                  ? k.call(i, j.term, j.page, j.context)
                  : k),
              null !== f && f.abort(),
              c.params &&
                (a.isFunction(c.params)
                  ? a.extend(n, c.params.call(i))
                  : a.extend(n, c.params)),
              a.extend(n, {
                url: k,
                dataType: c.dataType,
        ...
        (d = K(Object, {
                ...
                d.mousewheel(function (a, b, c, e) {
                  ...
                  e > 0 && 0 >= f - e
                    ...
                    : 0 > e &&
                      ...
                      (d.scrollTop(d.get(0).scrollHeight - d.height()), y(a));
                }),
              r(e),
              ...
              (e
                ? ((c.query = this.bind(function (c) {
                    ...
                    (j = function (a, b) {
                      var d;
                      a.is("option")
                        ? c.matcher(f, a.text(), a) && b.push(h.optionToData(a))
                        : a.is("optgroup") &&
                          ((d = h.optionToData(a)),
                ...
                : "query" in c ||
                  ("ajax" in c
                    ? ((g = c.element.data("ajax-url")),
                      ...
                      (c.query = D.call(c.element, c.ajax)))
                    : "data" in c
                    ? (c.query = E(c.data))
                    : "tags" in c &&
                      ((c.query = F(c.tags)),
          ...
          ensureHighlightVisible: function () {
            ...
            if (((e = this.highlight()), !(0 > e))) {
              ...
              (d = this.findHighlightableChoices().find(
                ".select2-result-label"
              )),
                (f = a(d[e])),
                (g = f.offset().top + f.outerHeight(!0)),
                e === d.length - 1 &&
                  ((j = c.find("li.select2-more-results")),
          ...
          highlight: function (c) {
            ...
            return 0 === arguments.length
              ? m(d.filter(".select2-highlighted")[0], d.get())
          ...
          updateResults: function (c) {
            ...
            if (
              ...
              if (
                ...
                a.isArray(g) &&
                  g.length >= n &&
                  G(f.formatSelectionTooBig, "formatSelectionTooBig"))
              )
                return (
                  m(
                    "<li class='select2-selection-limit'>" +
                      f.formatSelectionTooBig(n) +
                      "</li>"
                  ),
                  b
                );
              if (d.val().length < f.minimumInputLength)
                return (
                  G(f.formatInputTooShort, "formatInputTooShort")
                    ? m(
              ...
              if (f.maximumInputLength && d.val().length > f.maximumInputLength)
                return (
                  G(f.formatInputTooLong, "formatInputTooLong")
                    ? m(
                        "<li class='select2-no-results'>" +
                      ...
                      ? ((this.context = g.context === b ? null : g.context),
                        this.opts.createSearchChoice &&
                          ...
                          i !== b &&
                            ...
                            g.results.unshift(i)),
                        0 === g.results.length &&
                        G(f.formatNoMatches, "formatNoMatches")
                          ? (m(
                              "<li class='select2-no-results'>" +
                          ...
                          : (e.empty(),
                            ...
                            g.more === !0 &&
                              G(f.formatLoadMore, "formatLoadMore") &&
                              (e.append(
                            ...
                            b))
                      : (this.search.removeClass("select2-active"), b);
                  }),
                });
            }
          },
        ...
        (e = K(d, {
                ...
                this.bind(function (a) {
                  if (this.isInterfaceEnabled()) {
                    ...
                    switch (a.which) {
                      ...
                      case c.DOWN:
                        return (
                          this.moveHighlight(a.which === c.UP ? -1 : 1), y(a), b
                        );
                      case c.ENTER:
              ...
              this.focusser.on(
                ...
                this.bind(function (a) {
                  return !this.isInterfaceEnabled() ||
                    ...
                    a.which === c.ESC
                    ? b
                    : this.opts.openOnEnter === !1 && a.which === c.ENTER
                    ? (y(a), b)
                    : a.which == c.DOWN ||
                      a.which == c.UP ||
                      (a.which == c.ENTER && this.opts.openOnEnter)
                    ? (this.open(), y(a), b)
                    : a.which == c.DELETE || a.which == c.BACKSPACE
                    ? (this.opts.allowClear && this.clear(), y(a), b)
                    : b;
                })
              ),
              r(this.focusser),
              ...
              d.on(
                ...
                this.bind(function (a) {
                  this.isInterfaceEnabled() &&
                    (this.clear(), z(a), this.close(), this.selection.focus());
                })
              ),
              d.on(
                "mousedown",
          ...
          postprocessResults: function (a, c, d) {
            var e = 0,
              f = this;
            if (
              (this.findHighlightableChoices().each2(function (a, c) {
                return o(f.id(c.data("select2-data")), f.opts.element.val())
                  ? ((e = a), !1)
                  : b;
              }),
              d !== !1 && this.highlight(e),
              c === !0 && this.showSearchInput === !1)
            ) {
          ...
          data: function (a, c) {
            var d;
            return 0 === arguments.length
              ? ((d = this.selection.data("select2-data")),
                d == b && (d = null),
                d)
              : (a && "" !== a
                  ? ((d = this.data()),
                    ...
                    this.updateSelection(a),
                    c && this.triggerChange({ added: a, removed: d }))
                  : this.clear(c),
                b);
          },
        })),
        (f = K(d, {
          ...
          getVal: function () {
            ...
            return this.select
              ...
              : ((a = this.opts.element.val()), p(a, this.opts.separator));
          },
          setVal: function (b) {
            var c;
            this.select
          ...
          buildChangeDetails: function (a, b) {
            for (var b = b.slice(0), a = a.slice(0), c = 0; b.length > c; c++)
              for (var d = 0; a.length > d; d++)
                o(this.opts.id(b[c]), this.opts.id(a[d])) &&
          ...
          data: function (c, d) {
            ...
            return 0 === arguments.length
              ...
              : ((g = this.data()),
                ...
                this.clearSearch(),
                d &&
                  this.triggerChange(this.buildChangeDetails(g, this.data())),
                b);
          },
        })),
