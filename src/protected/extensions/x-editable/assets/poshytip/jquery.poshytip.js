...
(function ($) {
  ...
  $.Poshytip.prototype = {
    init: function () {
      ...
      this.$elm
        .data("title.poshytip", title !== undefined ? title : null)
        .data("poshytip", this);
    ...
    mouseleave: function (e) {
      if (
        this.disabled ||
        (this.asyncAnimating &&
          (this.$tip[0] === e.relatedTarget ||
            jQuery.contains(this.$tip[0], e.relatedTarget)))
      )
        return true;
      ...
      if (bgImage) {
        ...
        if (ie6 && bgImagePNG) {
          ...
          this.$tip
            ...
            .find(".tip-bg-image")
            .css("background-image", 'url("' + bgImage[1] + '")')
            .end()
            .find("td")
            .eq(3)
            .append(this.$inner);
        ...
        $table
          ...
          .width(
            (document.defaultView &&
              ...
              parseFloat(
                document.defaultView.getComputedStyle(this.$tip[0], null).width
              )) ||
              this.$tip.width()
          )
          .find("td")
    ...
    display: function (hide) {
      ...
      if (
        ...
        ((hide && this.opts.hideAniDuration) ||
          (!hide && this.opts.showAniDuration))
      ) {
        var from = {},
          to = {};
        ...
        this.$tip
          .css(from)
          .animate(to, this.opts[hide ? "hideAniDuration" : "showAniDuration"]);
      }
      hide
    ...
    calcPos: function () {
      ...
      switch (this.opts.alignX) {
        ...
        case "center":
          ...
          if (pos.l + this.tipOuterW > win.l + win.w)
            pos.l = win.l + win.w - this.tipOuterW;
          else if (pos.l < win.l) pos.l = win.l;
          break;
      ...
      switch (this.opts.alignY) {
        ...
        case "center":
          ...
          else if (pos.t < win.t) pos.t = win.t;
          break;
    ...
    if (!$("#poshytip-css-" + opts.className)[0])
      $(
        [
          ...
          " table.tip-table, div.",
          opts.className,
          " table.tip-table td{margin:0;font-family:inherit;font-size:inherit;font-weight:inherit;font-style:inherit;font-variant:inherit;}",
          "div.",
          opts.className,
