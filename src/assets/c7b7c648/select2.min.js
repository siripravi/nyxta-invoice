...
(function ($, undefined) {
    ...
    return function (query) {
      ...
      timeout = window.setTimeout(function () {
        ...
        if (options.params)
          ...
          else $.extend(params, options.params);
        $.extend(params, {
          url: url,
  ...
  AbstractSelect2 = clazz(Object, {
    ...
    prepareOpts: function (opts) {
      ...
      if (select) {
        ...
        } else if ("data" in opts) opts.query = local(opts.data);
    ...
    initContainerWidth: function () {
      function resolveContainerWidth() {
        ...
        if (this.opts.width === "off") return null;
          ...
          return null;
        } else if ($.isFunction(this.opts.width)) return this.opts.width();
  ...
  SingleSelect2 = clazz(AbstractSelect2, {
    ...
    getPlaceholder: function () {
      if (this.select)
        if (this.select.find("option").first().text() !== "") return undefined;
    ...
    data: function (value) {
      ...
      if (arguments.length === 0) {
        ...
        return data;
      } else if (!value || value === "") this.clear();
      else {
  ...
  MultiSelect2 = clazz(AbstractSelect2, {
      ...
      this.search.bind(
        ...
        this.bind(function (e) {
          ...
          if (e.which === KEY.ENTER)
            ...
            else if (e.altKey || e.ctrlKey || e.shiftKey || e.metaKey) return;
          this.open();
          if (e.which === KEY.PAGE_UP || e.which === KEY.PAGE_DOWN)
            killEvent(e);
        })
    ...
    setVal: function (val) {
      var unique;
      if (this.select) this.select.val(val);
      else {
        unique = [];
        $(val).each(function () {
  ...
  $.fn.select2 = function () {
    ...
    this.each(function () {
      if (args.length === 0 || typeof args[0] === "object") {
        ...
        if (args[0] === "container") value = select2.container;
        else value = select2[args[0]].apply(select2, args.slice(1));
