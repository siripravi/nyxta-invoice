...
(function ($, undefined) {
  ...
  function ajax(options) {
    ...
    return function (query) {
      ...
      timeout = window.setTimeout(function () {
        ...
        data = data
          ? data.call(this, query.term, query.page, query.context)
          : null;
        url =
          typeof url === "function"
            ? url.call(this, query.term, query.page, query.context)
            : url;
  ...
  SingleSelect2 = clazz(AbstractSelect2, {
          ...
          function (element, callback) {
            ...
            opts.query({
              ...
              callback: !$.isFunction(callback)
                ...
                : function (filtered) {
                    callback(
                      filtered.results.length ? filtered.results[0] : null
                    );
                  },
            });
          };
    ...
    showSearch: function (showSearchInput) {
      ...
      this.dropdown
        .find(".select2-search")
        [showSearchInput ? "removeClass" : "addClass"]("select2-search-hidden");
