...
(function (e) {
  ...
  (t.prototype = {
    ...
    initButtons: function () {
      ...
      t.append(e.fn.editableform.buttons),
        this.options.showbuttons === "bottom" &&
          t.addClass("editable-buttons-bottom");
    },
    render: function () {
    ...
    showLoading: function () {
      ...
      this.$form
        ? ((e = this.$form.outerWidth()),
          ...
          this.$form.hide())
        : ((e = this.$loading.parent().width()), e && this.$loading.width(e)),
        this.$loading.show();
    },
    showForm: function (e) {
      this.$loading.hide(),
    ...
    submit: function (t) {
      ...
      if (
        ...
        this.input.value2str(r) == this.input.value2str(this.value)
      ) {
            ...
            e.proxy(function (e) {
              ...
              var t =
                typeof this.options.success == "function"
                  ? this.options.success.call(this.options.scope, e, r)
                  : null;
              if (t === !1) {
          ...
          .fail(
            e.proxy(function (e) {
              ...
              typeof this.options.error == "function"
                ? (t = this.options.error.call(this.options.scope, e, r))
                : (t =
                    typeof e == "string"
                      ? e
        ...
        r = !!(
          ...
          (this.options.url &&
            (this.options.send === "always" ||
              (this.options.send === "auto" && n !== null && n !== undefined)))
        ),
        i;
      if (r)
        return (
          this.showLoading(),
          (i = { name: this.options.name || "", value: t, pk: n }),
          typeof this.options.params == "function"
            ? (i = this.options.params.call(this.options.scope, i))
            : ((this.options.params = e.fn.editableutils.tryParseJson(
                this.options.params,
                !0
              )),
    ...
    e.fn.editableutils = {
        ...
        return (
          e.each(t.data(), function (e, t) {
            if (
              ...
              (t &&
                typeof t == "object" &&
                (t.constructor === Object || t.constructor === Array))
            )
              n[e] = t;
          }),
          n
      ...
      createInput: function (t) {
        ...
        return (
          s === "date" &&
            (t.mode === "inline"
              ? e.fn.editabletypes.datefield
                ? (s = "datefield")
                : e.fn.editabletypes.dateuifield && (s = "dateuifield")
              : e.fn.editabletypes.date
              ? (s = "date")
              : e.fn.editabletypes.dateui && (s = "dateui"),
    ...
    (t.prototype = {
      ...
      init: function (n, r) {
        (this.$element = e(n)),
          ...
          e(document).data("editable-handlers-attached") ||
      ...
      splitOptions: function () {
        ...
        for (var n in this.options)
          n in t
            ? (this.containerOptions[n] = this.options[n])
            : (this.formOptions[n] = this.options[n]);
      },
      tip: function () {
          ...
          .on({
            ...
            rendered: e.proxy(function () {
              this.$element.triggerHandler(
                "shown",
                e(this.options.scope).data("editable")
              );
            }, this),
          })
          .editableform("render");
      ...
      option: function (e, t) {
        (this.options[e] = t),
          e in this.containerOptions
            ? ((this.containerOptions[e] = t), this.setContainerOption(e, t))
      ...
      closeOthers: function (t) {
        e(".editable-open").each(function (n, r) {
          ...
          if (!s) return;
          s.options.onblur === "cancel"
            ? i.data("editableContainer").hide("onblur")
            : s.options.onblur === "submit" &&
              i.data("editableContainer").tip().find("form").submit();
        });
      },
      activate: function () {
        this.tip &&
      ...
      (e.fn.editableContainer = function (r) {
        ...
        return this.each(function () {
          ...
          u || s.data(o, (u = new f(this, a))),
            typeof r == "string" &&
              u[r].apply(u, Array.prototype.slice.call(i, 1));
        });
      }),
  ...
  (function (e) {
    "use strict";
    e.extend(
      e.fn.editableContainer.Inline.prototype,
      e.fn.editableContainer.Popup.prototype,
      {
  ...
  (function (e) {
    ...
    var t = function (t, n) {
      (this.$element = e(t)),
        (this.options = e.extend(
          ...
          n,
          e.fn.editableutils.getConfigData(this.$element)
        )),
        this.options.selector ? this.initLive() : this.init(),
        this.options.highlight &&
          !e.fn.editableutils.supportsTransitions() &&
    ...
    (t.prototype = {
      ...
      init: function () {
        ...
        this.options.value === undefined || this.options.value === null
          ? ((this.value = this.input.html2value(e.trim(this.$element.html()))),
            (t = !0))
          : ((this.options.value = e.fn.editableutils.tryParseJson(
              this.options.value,
              !0
            )),
          ...
          typeof this.options.display == "function" &&
        ...
        switch (this.options.autotext) {
          ...
          case "auto":
            n =
              !e.trim(this.$element.text()).length &&
              this.value !== null &&
              this.value !== undefined &&
              !t;
            break;
      ...
      render: function (e) {
        ...
        return this.input.value2htmlFinal
          ...
          : typeof this.options.display == "function"
          ? this.options.display.call(this.$element[0], this.value, e)
      ...
      handleEmpty: function (t) {
        ...
        t !== undefined
          ? (this.isEmpty = t)
          : e.trim(this.$element.html()) === ""
          ? (this.isEmpty = !0)
          : e.trim(this.$element.text()) !== ""
          ? (this.isEmpty = !1)
            ...
            (n =
              ...
              (this.options.savenochange &&
                this.input.value2str(this.value) !==
                  this.input.value2str(t.newValue))),
            n
              ...
              arguments.length === 2 && arguments[1] === !0
                ...
                : this.each(function () {
                    ...
                    n &&
                      n.value !== undefined &&
                      n.value !== null &&
                      (r[n.options.name] = n.input.value2submit(n.value));
                  }),
              r
            );
          case "submit":
    ...
    (t.prototype = {
      ...
      setAttr: function (e) {
        this.options[e] !== undefined &&
          this.options[e] !== null &&
          this.$input.attr(e, this.options[e]);
      },
      option: function (e, t) {
        this.options[e] = t;
      },
      ...
      e.extend(t.prototype, {
        ...
        value2html: function (t, n, r, i) {
          var s = e.Deferred(),
            o = function () {
              typeof r == "function"
                ? r.call(n, t, this.sourceData, i)
                : this.value2htmlFinal(t, n),
                s.resolve();
            };
          return (
            t === null
              ? o.call(this)
              : this.onSourceReady(o, function () {
                  s.resolve();
                }),
            s.promise()
          );
        ...
        onSourceReady: function (t, n) {
          var r;
          e.isFunction(this.options.source)
        ...
        doPrepend: function () {
          if (
            ...
            return;
          e.isArray(this.prependData) ||
            (e.isFunction(this.options.prepend) &&
              (this.options.prepend = this.options.prepend.call(
                this.options.scope
              )),
            (this.options.prepend = e.fn.editableutils.tryParseJson(
              this.options.prepend,
              !0
            )),
            typeof this.options.prepend == "string" &&
                ...
                typeof s == "object"
                  ? ((n = 0),
                    ...
                    n === 1
                      ...
                      : n > 1 &&
                        (s.children &&
                          (s.children = this.makeArray(s.children)),
                        i.push(s)))
                  : i.push({ value: s, text: s });
          } else
      ...
      e.extend(t.prototype, {
        ...
        activate: function () {
          this.$input.is(":visible") &&
            (this.$input.focus(),
            e.fn.editableutils.setCursorPosition(
              this.$input.get(0),
    ...
    e.fn.editableutils.inherit(t, e.fn.editabletypes.list),
      e.extend(t.prototype, {
        ...
        value2str: function (t) {
          return e.isArray(t)
            ? t.sort().join(e.trim(this.options.separator))
            : "";
        },
        str2value: function (t) {
          ...
          return (
            typeof t == "string" && t.length
              ? ((n = new RegExp(
                  "\\s*" + e.trim(this.options.separator) + "\\s*"
                )),
                (r = t.split(n)))
              : e.isArray(t)
              ? (r = t)
  ...
  (function (e) {
    ...
    var t = function (n) {
        ...
        e.isFunction(n.source) && (r = n.source.call(n.scope)),
          typeof r == "string"
            ? ((n.select2.ajax = n.select2.ajax || {}),
              n.select2.ajax.data ||
                (n.select2.ajax.data = function (e) {
                  return { query: e };
                }),
              n.select2.ajax.results ||
                (n.select2.ajax.results = function (e) {
                  return { results: e };
                }),
      ...
      (this.formatSelection = this.options.select2.formatSelection),
        typeof this.formatSelection != "function" &&
      ...
      e.extend(t.prototype, {
        ...
        value2html: function (t, n) {
          ...
          this.options.select2.tags
            ? (i = t)
            : this.sourceData &&
              (i = e.fn.editableutils.itemsByValue(
                t,
                this.sourceData,
                this.idFunc
              )),
        ...
        html2value: function (e) {
          return this.options.select2.tags
            ? this.str2value(e, this.options.viewseparator)
            : null;
        },
        value2input: function (t) {
        ...
        str2value: function (t, n) {
          ...
          n =
            ...
            e.fn.select2.defaults.separator;
          var r, i, s;
        ...
        convertSource: function (t) {
          if (e.isArray(t) && t.length && t[0].value !== undefined)
            for (var n = 0; n < t.length; n++)
              t[n].value !== undefined &&
                ((t[n].id = t[n].value), delete t[n].value);
          return t;
        },
        destroy: function () {
    ...
    (t.prototype = {
      ...
      init: function () {
        (this.map = {
          ...
          (this.$widget = e('<span class="combodate"></span>').html(
            this.getTemplate()
          )),
          this.initCombos(),
          this.$widget.on(
      ...
      fillMonth: function () {
        ...
        for (n = 0; n <= 11; n++)
          r
            ? (t = moment().date(1).month(n).format("MMMM"))
            : i
            ? (t = moment().date(1).month(n).format("MMM"))
            : s
            ? (t = this.leadZero(n + 1))
            : (t = n + 1),
            e.push([n, t]);
      ...
      getValue: function (t) {
        ...
        return (
          ...
          s
            ...
            : (this.$ampm &&
                (r.hour === 12
                  ? (r.hour = this.$ampm.val() === "am" ? 0 : 12)
                  : (r.hour =
                      this.$ampm.val() === "am" ? r.hour : r.hour + 12)),
              (n = moment([
                r.year,
                r.month,
                r.day,
      ...
      setValue: function (t) {
        ...
        if (!t) return;
        var n =
            typeof t == "string" ? moment(t, this.options.format) : moment(t),
          r = this,
          i = {};
        n.isValid() &&
          (e.each(this.map, function (e, t) {
          ...
          this.$ampm &&
            (i.hour >= 12
              ? ((i.ampm = "pm"), i.hour > 12 && (i.hour -= 12))
              : ((i.ampm = "am"), i.hour === 0 && (i.hour = 12))),
          e.each(i, function (e, t) {
            r["$" + e] &&
              (e === "minute" &&
                r.options.minuteStep > 1 &&
                r.options.roundTime &&
                (t = s(r["$" + e], t)),
              e === "second" &&
                r.options.secondStep > 1 &&
                r.options.roundTime &&
                (t = s(r["$" + e], t)),
              r["$" + e].val(t));
          }),
      ...
      (e.fn.combodate = function (n) {
        ...
        return (
          i.shift(),
          n === "getValue" && this.length && (r = this.eq(0).data("combodate"))
            ? r.getValue.apply(r, i)
            : this.each(function () {
                var r = e(this),
                  s = r.data("combodate"),
                  o = typeof n == "object" && n;
  ...
  (function (e) {
    ...
    e.extend(e.fn.editableContainer.Popup.prototype, {
      ...
      innerCss:
        e.fn.popover && e(e.fn.popover.defaults.template).find("p").length
          ? ".popover-content p"
          : ".popover-content",
      initContainer: function () {
      ...
      setPosition: function () {
        (function () {
          ...
          (o =
            ...
            (s = t[0].offsetHeight),
            (o = n ? o.split(" ")[1] : o),
            (f = { top: r.top + r.height, left: r.left + r.width / 2 - i / 2 }),
            (a = { top: r.top - s, left: r.left + r.width / 2 - i / 2 }),
            (l = { top: r.top + r.height / 2 - s / 2, left: r.left - i }),
            (c = { top: r.top + r.height / 2 - s / 2, left: r.left + r.width });
          switch (o) {
            case "bottom":
              f.top + s > e(window).scrollTop() + e(window).height() &&
                (a.top > e(window).scrollTop()
                  ? (o = "top")
                  : c.left + i < e(window).scrollLeft() + e(window).width()
                  ? (o = "right")
                  : l.left > e(window).scrollLeft()
                  ? (o = "left")
                  : (o = "right"));
              break;
            case "top":
            ...
            case "right":
              c.left + i > e(window).scrollLeft() + e(window).width() &&
                (l.left > e(window).scrollLeft()
                  ...
                  : a.top > e(window).scrollTop()
                  ? (o = "top")
                  : a.top > e(window).scrollTop() && (o = "bottom"));
          }
          switch (o) {
            case "bottom":
              u = f;
  ...
  (function (e) {
    ...
    r.prototype = {
      ...
      _process_options: function (t) {
        ...
        n.startDate !== -Infinity &&
          (n.startDate = h.parseDate(n.startDate, i, n.language)),
          n.endDate !== Infinity &&
            (n.endDate = h.parseDate(n.endDate, i, n.language)),
          (n.daysOfWeekDisabled = n.daysOfWeekDisabled || []),
          e.isArray(n.daysOfWeekDisabled) ||
            (n.daysOfWeekDisabled = n.daysOfWeekDisabled.split(/[,\s]*/)),
      ...
      _applyEvents: function (e) {
        for (var t = 0, n, r; t < e.length; t++)
          (n = e[t][0]), (r = e[t][1]), n.on(r);
      },
      _unapplyEvents: function (e) {
        for (var t = 0, n, r; t < e.length; t++)
          (n = e[t][0]), (r = e[t][1]), n.off(r);
      },
      ...
      fillDow: function () {
        ...
        while (e < this.o.weekStart + 7)
          t +=
            '<th class="dow">' + c[this.o.language].daysMin[e++ % 7] + "</th>";
      ...
      fillMonths: function () {
        ...
        while (t < 12)
          e +=
            '<span class="month">' +
            c[this.o.language].monthsShort[t++] +
            "</span>";
      ...
      getClassNames: function (t) {
        ...
        return (
          t.getUTCFullYear() < r ||
          (t.getUTCFullYear() == r && t.getUTCMonth() < i)
            ? n.push("old")
            : (t.getUTCFullYear() > r ||
                (t.getUTCFullYear() == r && t.getUTCMonth() > i)) &&
              n.push("new"),
          this.o.todayHighlight &&
            t.getUTCFullYear() == o.getFullYear() &&
            t.getUTCMonth() == o.getMonth() &&
            t.getUTCDate() == o.getDate() &&
            n.push("today"),
          s && t.valueOf() == s && n.push("active"),
          (t.valueOf() < this.o.startDate ||
            t.valueOf() > this.o.endDate ||
            e.inArray(t.getUTCDay(), this.o.daysOfWeekDisabled) !== -1) &&
            n.push("disabled"),
          this.range &&
            (t > this.range[0] &&
      ...
      fill: function () {
        ...
        this.picker
          ...
          .text(c[this.o.language].months[i] + " " + r),
          this.picker
            .find("tfoot th.today")
    ...
    var i = function (t, n) {
      (this.element = e(t)),
        ...
        e(this.inputs)
          .datepicker(n)
          .bind("changeDate", e.proxy(this.dateUpdated, this)),
      ...
      h = {
        ...
        parseDate: function (n, i, s) {
          ...
          if (u.length == y.length) {
            ...
            for (var l = 0, w; l < d.length; l++)
              (w = d[l]), w in p && !isNaN(p[w]) && v[w](n, p[w]);
          }
          return n;
        },
        formatDate: function (t, n, r) {
          ...
          for (var o = 0, u = n.parts.length; o <= u; o++)
            s.length && t.push(s.shift()), t.push(i[n.parts[o]]);
          return t.join("");
        },
        headTemplate:
        ...
        render: function () {
          this.$input.bdatepicker(this.options.datepicker),
            this.options.clear &&
              ...
              this.$tpl
                .parent()
                .append(e('<div class="editable-clear">').append(this.$clear)));
        },
    ...
    e.fn.editableutils.inherit(t, e.fn.editabletypes.abstractinput),
      e.extend(t.prototype, {
        initPicker: function (t, n) {
          this.options.viewformat ||
            (this.options.viewformat = this.options.format),
            (t.datetimepicker = e.fn.editableutils.tryParseJson(
              t.datetimepicker,
              !0
            )),
      ...
      e.extend(t.prototype, {
        ...
        input2value: function () {
          if (this.getIsObjects()) {
            ...
            return n.length &&
              n[0].text.toLowerCase() === this.$input.val().toLowerCase()
              ? t
              : null;
          }
          return this.$input.val();
        ...
        matcher: function (t) {
          return e.fn.typeahead.Constructor.prototype.matcher.call(
            this,
            t.text
          );
        },
        ...
        highlighter: function (t) {
          return e.fn.typeahead.Constructor.prototype.highlighter.call(
            this,
            t.text
          );
        },
        ...
        typeaheadRender: function (t) {
          ...
          return (
            (t = e(t).map(function (t, r) {
              return (
                (t = e(n.options.item).data("item", r)),
