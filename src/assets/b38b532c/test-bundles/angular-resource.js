 ...
 */
  ...
  describe("resource", function () {
    ...
    describe("basic usage", function () {
      ...
      it("should support IPv6 URLs", function () {
        ...
        function test(templateUrl, params, actualUrl) {
          var R = $resource(templateUrl, null, null, {
            stripTrailingSlashes: false,
          });
      ...
      it("should send correct headers", function () {
        $httpBackend
          .expectPUT("/CreditCard/123", undefined, function (headers) {
      ...
      it("should have all arguments optional", function () {
        ...
        var log = "";
        var ccs = CreditCard.query(function () {
          log += "cb;";
        });
      ...
      describe("promise api", function () {
        ...
        describe("responseInterceptor", function () {
          ...
          it("should fulfill the promise with the value returned by the response interceptor", function () {
          ...
          it("should fulfill the promise with the value returned by the responseError interceptor", function () {
      ...
      describe("success mode", function () {
        it("should call the success callback (as 1st argument) on 2xx responses", function () {
          ...
          var successCb = jasmine
            .createSpy("successCb")
            .and.callFake(function (d, h, s, t) {
      ...
      describe("failure mode", function () {
        ...
        beforeEach(function () {
          errorCB = jasmine
            .createSpy("error")
            .and.callFake(function (response) {
        ...
        describe("query", function () {
          ...
          it("should work when query parameters are supplied", function () {
            $httpBackend
              ...
              .respond([{ id: 1, name: "user1" }]);
            var UserService = $resource("/users/:user_id.json", {
              user_id: "@id",
            });
          ...
          it("should work when query parameters are supplied and the format is a resource parameter", function () {
            $httpBackend
              .expect("GET", "/users.json?red=blue")
              .respond([{ id: 1, name: "user1" }]);
            var UserService = $resource("/users/:user_id.:format", {
              user_id: "@id",
              format: "json",
            });
            var user = UserService.query({ red: "blue" });
    ...
    describe("extra params", function () {
      ...
      it("should pass extra params even if `Object.prototype` has properties with the same name", function () {
    ...
    describe("errors", function () {
      ...
      it("should fail if action expects an object but response is an array", function () {
        ...
        $resource("/Customer/123")
          .query()
          .$promise.then(successSpy, function (e) {
    ...
    describe("handling rejections", function () {
      ...
      it("should report a PUR when no error callback or responseError interceptor is provided", function () {
        var CreditCard = $resource("/CreditCard");
      ...
      it("should not report a PUR when an error callback or responseError interceptor is provided", function () {
        var CreditCard = $resource(
          "/CreditCard",
          {},
          {
      ...
      it("should report a PUR when the responseError interceptor returns a rejected promise", inject(function (
        $q
      ) {
        var CreditCard = $resource(
          "/CreditCard",
      ...
      it("should not swallow exceptions in success callback when error callback is provided", function () {
      ...
      it("should not swallow exceptions in success callback when error callback is not provided", function () {
        $httpBackend.expectGET("/CreditCard/123").respond(null);
        var CreditCard = $resource("/CreditCard/:id");
        CreditCard.get({ id: 123 }, function (res) {
          throw new Error("should be caught");
        });
      ...
      it("should not swallow exceptions in success callback when error callback is provided and has responseError interceptor", function () {
        $httpBackend.expectGET("/CreditCard/123").respond(null);
      ...
      it("should not swallow exceptions in success callback when error callback is not provided and has responseError interceptor", function () {
        $httpBackend.expectGET("/CreditCard/123").respond(null);
        var CreditCard = $resource("/CreditCard/:id", null, {
          get: {
            method: "GET",
      ...
      it("should not propagate exceptions in success callback to the returned promise", function () {
        var successCallbackSpy = jasmine
      ...
      it("should not be able to recover from inside the error callback", function () {
        ...
        var CreditCard = $resource("/CreditCard/:id");
        CreditCard.get({ id: 123 }, noop, errorCallbackSpy).$promise.then(
          promiseResolveSpy,
          promiseRejectSpy
        );
    ...
    describe("cancelling requests", function () {
      ...
      it("should delete non-numeric timeouts in actions and log a $debug message", inject(function (
        $log,
        $q
      ) {
        spyOn($log, "debug");
      ...
      it("should use `cancellable` value if passed a non-numeric `timeout` in an action", inject(function (
        $log,
        $q,
        $rootScope
      ) {
